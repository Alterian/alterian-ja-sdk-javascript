...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://localhost/services/api.svc/jsonsdk') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://localhost/services/api.svc/jsonsdk
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/6.35.0/Javascript'
        };
