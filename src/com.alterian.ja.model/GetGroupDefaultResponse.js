...
import ALUserGroup from './ALUserGroup';
import APICursor from './APICursor';
import OperationResult from './OperationResult';

/**
 * The GetGroupDefaultResponse model module.
 * @module com.alterian.ja.model/GetGroupDefaultResponse
 * @version 6.35.0
 */
class GetGroupDefaultResponse {
    /**
     * Constructs a new <code>GetGroupDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetGroupDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetGroupDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetGroupDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetGroupDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetGroupDefaultResponse} The populated <code>GetGroupDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetGroupDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ALUserGroup.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetGroupDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetGroupDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          ALUserGroup.validateJSON(data['Result']);
        }
 ...
 */
GetGroupDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetGroupDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetGroupDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetGroupDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.ja.model/ALUserGroup} Result
 */
GetGroupDefaultResponse.prototype['Result'] = undefined;
...
export default GetGroupDefaultResponse;
