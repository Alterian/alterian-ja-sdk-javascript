...
import EMDownloadMapping from './EMDownloadMapping';
import OperationResult from './OperationResult';

/**
 * The GetEMDownloadMappingsDefaultResponse model module.
 * @module com.alterian.ja.model/GetEMDownloadMappingsDefaultResponse
 * @version 6.35.0
 */
class GetEMDownloadMappingsDefaultResponse {
    /**
     * Constructs a new <code>GetEMDownloadMappingsDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetEMDownloadMappingsDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetEMDownloadMappingsDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetEMDownloadMappingsDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetEMDownloadMappingsDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetEMDownloadMappingsDefaultResponse} The populated <code>GetEMDownloadMappingsDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetEMDownloadMappingsDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [EMDownloadMapping]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetEMDownloadMappingsDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetEMDownloadMappingsDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
            ...
            for (const item of data['Result']) {
                EMDownloadMapping.validateJSON(item);
            };
        }
 ...
 */
GetEMDownloadMappingsDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetEMDownloadMappingsDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetEMDownloadMappingsDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetEMDownloadMappingsDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/EMDownloadMapping>} Result
 */
GetEMDownloadMappingsDefaultResponse.prototype['Result'] = undefined;
...
export default GetEMDownloadMappingsDefaultResponse;
