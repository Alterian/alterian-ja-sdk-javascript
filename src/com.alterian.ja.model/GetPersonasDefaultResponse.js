...
/**
 * The GetPersonasDefaultResponse model module.
 * @module com.alterian.ja.model/GetPersonasDefaultResponse
 * @version 6.35.0
 */
class GetPersonasDefaultResponse {
    /**
     * Constructs a new <code>GetPersonasDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetPersonasDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetPersonasDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetPersonasDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetPersonasDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetPersonasDefaultResponse} The populated <code>GetPersonasDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPersonasDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [Persona]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPersonasDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPersonasDefaultResponse</code>.
     */
 ...
 */
GetPersonasDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetPersonasDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetPersonasDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetPersonasDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/Persona>} Result
 */
GetPersonasDefaultResponse.prototype['Result'] = undefined;
...
export default GetPersonasDefaultResponse;
