...
import SankeyFavourite from './SankeyFavourite';

/**
 * The GetSankeyFavouritesDefaultResponse model module.
 * @module com.alterian.ja.model/GetSankeyFavouritesDefaultResponse
 * @version 6.35.0
 */
class GetSankeyFavouritesDefaultResponse {
    /**
     * Constructs a new <code>GetSankeyFavouritesDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetSankeyFavouritesDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetSankeyFavouritesDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetSankeyFavouritesDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetSankeyFavouritesDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetSankeyFavouritesDefaultResponse} The populated <code>GetSankeyFavouritesDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetSankeyFavouritesDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [SankeyFavourite]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetSankeyFavouritesDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSankeyFavouritesDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
            ...
            for (const item of data['Result']) {
                SankeyFavourite.validateJSON(item);
            };
        }
 ...
 */
GetSankeyFavouritesDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetSankeyFavouritesDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetSankeyFavouritesDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetSankeyFavouritesDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/SankeyFavourite>} Result
 */
GetSankeyFavouritesDefaultResponse.prototype['Result'] = undefined;
...
export default GetSankeyFavouritesDefaultResponse;
