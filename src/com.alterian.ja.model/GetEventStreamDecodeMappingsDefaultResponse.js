...
import EventStreamDecodeMappings from './EventStreamDecodeMappings';
import OperationResult from './OperationResult';

/**
 * The GetEventStreamDecodeMappingsDefaultResponse model module.
 * @module com.alterian.ja.model/GetEventStreamDecodeMappingsDefaultResponse
 * @version 6.35.0
 */
class GetEventStreamDecodeMappingsDefaultResponse {
    /**
     * Constructs a new <code>GetEventStreamDecodeMappingsDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetEventStreamDecodeMappingsDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetEventStreamDecodeMappingsDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetEventStreamDecodeMappingsDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetEventStreamDecodeMappingsDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetEventStreamDecodeMappingsDefaultResponse} The populated <code>GetEventStreamDecodeMappingsDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetEventStreamDecodeMappingsDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = EventStreamDecodeMappings.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetEventStreamDecodeMappingsDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetEventStreamDecodeMappingsDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          EventStreamDecodeMappings.validateJSON(data['Result']);
        }
 ...
 */
GetEventStreamDecodeMappingsDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetEventStreamDecodeMappingsDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetEventStreamDecodeMappingsDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetEventStreamDecodeMappingsDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.ja.model/EventStreamDecodeMappings} Result
 */
GetEventStreamDecodeMappingsDefaultResponse.prototype['Result'] = undefined;
...
export default GetEventStreamDecodeMappingsDefaultResponse;
