...
/**
 * The GetDatasourceColumnDefaultResponse model module.
 * @module com.alterian.ja.model/GetDatasourceColumnDefaultResponse
 * @version 6.35.0
 */
class GetDatasourceColumnDefaultResponse {
    /**
     * Constructs a new <code>GetDatasourceColumnDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetDatasourceColumnDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetDatasourceColumnDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetDatasourceColumnDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetDatasourceColumnDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetDatasourceColumnDefaultResponse} The populated <code>GetDatasourceColumnDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDatasourceColumnDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ALDataSourceColumn.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetDatasourceColumnDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDatasourceColumnDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          ALDataSourceColumn.validateJSON(data['Result']);
        }
 ...
 */
GetDatasourceColumnDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetDatasourceColumnDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetDatasourceColumnDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetDatasourceColumnDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.ja.model/ALDataSourceColumn} Result
 */
GetDatasourceColumnDefaultResponse.prototype['Result'] = undefined;
...
export default GetDatasourceColumnDefaultResponse;
