...
/**
 * The AreDatasourceCampaignsPausedDefaultResponse model module.
 * @module com.alterian.ja.model/AreDatasourceCampaignsPausedDefaultResponse
 * @version 6.35.0
 */
class AreDatasourceCampaignsPausedDefaultResponse {
    /**
     * Constructs a new <code>AreDatasourceCampaignsPausedDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/AreDatasourceCampaignsPausedDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        AreDatasourceCampaignsPausedDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AreDatasourceCampaignsPausedDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/AreDatasourceCampaignsPausedDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/AreDatasourceCampaignsPausedDefaultResponse} The populated <code>AreDatasourceCampaignsPausedDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AreDatasourceCampaignsPausedDefaultResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>AreDatasourceCampaignsPausedDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AreDatasourceCampaignsPausedDefaultResponse</code>.
     */
 ...
 */
AreDatasourceCampaignsPausedDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
AreDatasourceCampaignsPausedDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
AreDatasourceCampaignsPausedDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
AreDatasourceCampaignsPausedDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<Number>} Result
 */
AreDatasourceCampaignsPausedDefaultResponse.prototype['Result'] = undefined;
...
export default AreDatasourceCampaignsPausedDefaultResponse;
