...
import PatternScoreList from './PatternScoreList';

/**
 * The GetRepeatingPatternItemScoresDefaultResponse model module.
 * @module com.alterian.ja.model/GetRepeatingPatternItemScoresDefaultResponse
 * @version 6.35.0
 */
class GetRepeatingPatternItemScoresDefaultResponse {
    /**
     * Constructs a new <code>GetRepeatingPatternItemScoresDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetRepeatingPatternItemScoresDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetRepeatingPatternItemScoresDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetRepeatingPatternItemScoresDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetRepeatingPatternItemScoresDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetRepeatingPatternItemScoresDefaultResponse} The populated <code>GetRepeatingPatternItemScoresDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetRepeatingPatternItemScoresDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = PatternScoreList.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetRepeatingPatternItemScoresDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetRepeatingPatternItemScoresDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          PatternScoreList.validateJSON(data['Result']);
        }
 ...
 */
GetRepeatingPatternItemScoresDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetRepeatingPatternItemScoresDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetRepeatingPatternItemScoresDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetRepeatingPatternItemScoresDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.ja.model/PatternScoreList} Result
 */
GetRepeatingPatternItemScoresDefaultResponse.prototype['Result'] = undefined;
...
export default GetRepeatingPatternItemScoresDefaultResponse;
