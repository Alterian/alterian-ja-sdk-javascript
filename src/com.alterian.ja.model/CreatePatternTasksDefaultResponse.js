...
import PatternTask from './PatternTask';

/**
 * The CreatePatternTasksDefaultResponse model module.
 * @module com.alterian.ja.model/CreatePatternTasksDefaultResponse
 * @version 6.35.0
 */
class CreatePatternTasksDefaultResponse {
    /**
     * Constructs a new <code>CreatePatternTasksDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/CreatePatternTasksDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        CreatePatternTasksDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreatePatternTasksDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/CreatePatternTasksDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/CreatePatternTasksDefaultResponse} The populated <code>CreatePatternTasksDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePatternTasksDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [PatternTask]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePatternTasksDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePatternTasksDefaultResponse</code>.
     */
 ...
 */
CreatePatternTasksDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
CreatePatternTasksDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
CreatePatternTasksDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
CreatePatternTasksDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/PatternTask>} Result
 */
CreatePatternTasksDefaultResponse.prototype['Result'] = undefined;
...
export default CreatePatternTasksDefaultResponse;
