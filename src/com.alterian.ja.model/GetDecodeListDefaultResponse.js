...
/**
 * The GetDecodeListDefaultResponse model module.
 * @module com.alterian.ja.model/GetDecodeListDefaultResponse
 * @version 6.35.0
 */
class GetDecodeListDefaultResponse {
    /**
     * Constructs a new <code>GetDecodeListDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetDecodeListDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetDecodeListDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetDecodeListDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetDecodeListDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetDecodeListDefaultResponse} The populated <code>GetDecodeListDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDecodeListDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = DecodeList.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetDecodeListDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDecodeListDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          DecodeList.validateJSON(data['Result']);
        }
 ...
 */
GetDecodeListDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetDecodeListDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetDecodeListDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetDecodeListDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.ja.model/DecodeList} Result
 */
GetDecodeListDefaultResponse.prototype['Result'] = undefined;
...
export default GetDecodeListDefaultResponse;
