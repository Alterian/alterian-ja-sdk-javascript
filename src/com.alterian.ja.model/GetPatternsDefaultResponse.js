...
/**
 * The GetPatternsDefaultResponse model module.
 * @module com.alterian.ja.model/GetPatternsDefaultResponse
 * @version 6.35.0
 */
class GetPatternsDefaultResponse {
    /**
     * Constructs a new <code>GetPatternsDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetPatternsDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetPatternsDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetPatternsDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetPatternsDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetPatternsDefaultResponse} The populated <code>GetPatternsDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPatternsDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [Pattern]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPatternsDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPatternsDefaultResponse</code>.
     */
 ...
 */
GetPatternsDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetPatternsDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetPatternsDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetPatternsDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/Pattern>} Result
 */
GetPatternsDefaultResponse.prototype['Result'] = undefined;
...
export default GetPatternsDefaultResponse;
