...
import FieldTransformationResult from './FieldTransformationResult';
import OperationResult from './OperationResult';

/**
 * The GetFieldTransformationMappingsDefaultResponse model module.
 * @module com.alterian.ja.model/GetFieldTransformationMappingsDefaultResponse
 * @version 6.35.0
 */
class GetFieldTransformationMappingsDefaultResponse {
    /**
     * Constructs a new <code>GetFieldTransformationMappingsDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetFieldTransformationMappingsDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetFieldTransformationMappingsDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetFieldTransformationMappingsDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetFieldTransformationMappingsDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetFieldTransformationMappingsDefaultResponse} The populated <code>GetFieldTransformationMappingsDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetFieldTransformationMappingsDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = FieldTransformationResult.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetFieldTransformationMappingsDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetFieldTransformationMappingsDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          FieldTransformationResult.validateJSON(data['Result']);
        }
 ...
 */
GetFieldTransformationMappingsDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetFieldTransformationMappingsDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetFieldTransformationMappingsDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetFieldTransformationMappingsDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.ja.model/FieldTransformationResult} Result
 */
GetFieldTransformationMappingsDefaultResponse.prototype['Result'] = undefined;
...
export default GetFieldTransformationMappingsDefaultResponse;
