...
/**
 * The GetDataSourceUsersDefaultResponse model module.
 * @module com.alterian.ja.model/GetDataSourceUsersDefaultResponse
 * @version 6.35.0
 */
class GetDataSourceUsersDefaultResponse {
    /**
     * Constructs a new <code>GetDataSourceUsersDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetDataSourceUsersDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetDataSourceUsersDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetDataSourceUsersDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetDataSourceUsersDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetDataSourceUsersDefaultResponse} The populated <code>GetDataSourceUsersDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDataSourceUsersDefaultResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetDataSourceUsersDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDataSourceUsersDefaultResponse</code>.
     */
 ...
 */
GetDataSourceUsersDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetDataSourceUsersDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetDataSourceUsersDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetDataSourceUsersDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<String>} Result
 */
GetDataSourceUsersDefaultResponse.prototype['Result'] = undefined;
...
export default GetDataSourceUsersDefaultResponse;
