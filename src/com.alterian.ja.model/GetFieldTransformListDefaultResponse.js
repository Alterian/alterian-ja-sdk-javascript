...
import FieldTransformList from './FieldTransformList';
import OperationResult from './OperationResult';

/**
 * The GetFieldTransformListDefaultResponse model module.
 * @module com.alterian.ja.model/GetFieldTransformListDefaultResponse
 * @version 6.35.0
 */
class GetFieldTransformListDefaultResponse {
    /**
     * Constructs a new <code>GetFieldTransformListDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetFieldTransformListDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetFieldTransformListDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetFieldTransformListDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetFieldTransformListDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetFieldTransformListDefaultResponse} The populated <code>GetFieldTransformListDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetFieldTransformListDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = FieldTransformList.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetFieldTransformListDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetFieldTransformListDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          FieldTransformList.validateJSON(data['Result']);
        }
 ...
 */
GetFieldTransformListDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetFieldTransformListDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetFieldTransformListDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetFieldTransformListDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.ja.model/FieldTransformList} Result
 */
GetFieldTransformListDefaultResponse.prototype['Result'] = undefined;
...
export default GetFieldTransformListDefaultResponse;
