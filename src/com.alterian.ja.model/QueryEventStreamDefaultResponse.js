...
import QueryEventStreamResult from './QueryEventStreamResult';

/**
 * The QueryEventStreamDefaultResponse model module.
 * @module com.alterian.ja.model/QueryEventStreamDefaultResponse
 * @version 6.35.0
 */
class QueryEventStreamDefaultResponse {
    /**
     * Constructs a new <code>QueryEventStreamDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/QueryEventStreamDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        QueryEventStreamDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>QueryEventStreamDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/QueryEventStreamDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/QueryEventStreamDefaultResponse} The populated <code>QueryEventStreamDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new QueryEventStreamDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = QueryEventStreamResult.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>QueryEventStreamDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>QueryEventStreamDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          QueryEventStreamResult.validateJSON(data['Result']);
        }
 ...
 */
QueryEventStreamDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
QueryEventStreamDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
QueryEventStreamDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
QueryEventStreamDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.ja.model/QueryEventStreamResult} Result
 */
QueryEventStreamDefaultResponse.prototype['Result'] = undefined;
...
export default QueryEventStreamDefaultResponse;
