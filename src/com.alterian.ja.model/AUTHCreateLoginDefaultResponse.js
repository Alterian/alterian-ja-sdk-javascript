...
/**
 * The AUTHCreateLoginDefaultResponse model module.
 * @module com.alterian.ja.model/AUTHCreateLoginDefaultResponse
 * @version 6.35.0
 */
class AUTHCreateLoginDefaultResponse {
    /**
     * Constructs a new <code>AUTHCreateLoginDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/AUTHCreateLoginDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        AUTHCreateLoginDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AUTHCreateLoginDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/AUTHCreateLoginDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/AUTHCreateLoginDefaultResponse} The populated <code>AUTHCreateLoginDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AUTHCreateLoginDefaultResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>AUTHCreateLoginDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AUTHCreateLoginDefaultResponse</code>.
     */
 ...
 */
AUTHCreateLoginDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
AUTHCreateLoginDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
AUTHCreateLoginDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
AUTHCreateLoginDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {String} Result
 */
AUTHCreateLoginDefaultResponse.prototype['Result'] = undefined;
...
export default AUTHCreateLoginDefaultResponse;
