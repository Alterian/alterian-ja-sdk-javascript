...
import VisualisationFavourite from './VisualisationFavourite';

/**
 * The GetVisualisationFavouritesDefaultResponse model module.
 * @module com.alterian.ja.model/GetVisualisationFavouritesDefaultResponse
 * @version 6.35.0
 */
class GetVisualisationFavouritesDefaultResponse {
    /**
     * Constructs a new <code>GetVisualisationFavouritesDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetVisualisationFavouritesDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetVisualisationFavouritesDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetVisualisationFavouritesDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetVisualisationFavouritesDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetVisualisationFavouritesDefaultResponse} The populated <code>GetVisualisationFavouritesDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetVisualisationFavouritesDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [VisualisationFavourite]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetVisualisationFavouritesDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetVisualisationFavouritesDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
            ...
            for (const item of data['Result']) {
                VisualisationFavourite.validateJSON(item);
            };
        }
 ...
 */
GetVisualisationFavouritesDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetVisualisationFavouritesDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetVisualisationFavouritesDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetVisualisationFavouritesDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/VisualisationFavourite>} Result
 */
GetVisualisationFavouritesDefaultResponse.prototype['Result'] = undefined;
...
export default GetVisualisationFavouritesDefaultResponse;
