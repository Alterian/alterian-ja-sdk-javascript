...
import EMVariable from './EMVariable';
import OperationResult from './OperationResult';

/**
 * The EMGetCreativeFieldsDefaultResponse model module.
 * @module com.alterian.ja.model/EMGetCreativeFieldsDefaultResponse
 * @version 6.35.0
 */
class EMGetCreativeFieldsDefaultResponse {
    /**
     * Constructs a new <code>EMGetCreativeFieldsDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/EMGetCreativeFieldsDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        EMGetCreativeFieldsDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EMGetCreativeFieldsDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/EMGetCreativeFieldsDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/EMGetCreativeFieldsDefaultResponse} The populated <code>EMGetCreativeFieldsDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EMGetCreativeFieldsDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [EMVariable]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EMGetCreativeFieldsDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EMGetCreativeFieldsDefaultResponse</code>.
     */
 ...
 */
EMGetCreativeFieldsDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
EMGetCreativeFieldsDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
EMGetCreativeFieldsDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
EMGetCreativeFieldsDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/EMVariable>} Result
 */
EMGetCreativeFieldsDefaultResponse.prototype['Result'] = undefined;
...
export default EMGetCreativeFieldsDefaultResponse;
