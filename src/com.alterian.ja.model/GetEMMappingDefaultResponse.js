...
/**
 * The GetEMMappingDefaultResponse model module.
 * @module com.alterian.ja.model/GetEMMappingDefaultResponse
 * @version 6.35.0
 */
class GetEMMappingDefaultResponse {
    /**
     * Constructs a new <code>GetEMMappingDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetEMMappingDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetEMMappingDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetEMMappingDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetEMMappingDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetEMMappingDefaultResponse} The populated <code>GetEMMappingDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetEMMappingDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = EMUploadMapping.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetEMMappingDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetEMMappingDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          EMUploadMapping.validateJSON(data['Result']);
        }
 ...
 */
GetEMMappingDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetEMMappingDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetEMMappingDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetEMMappingDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.ja.model/EMUploadMapping} Result
 */
GetEMMappingDefaultResponse.prototype['Result'] = undefined;
...
export default GetEMMappingDefaultResponse;
