...
/**
 * The AUTHGetClientLoginsDefaultResponse model module.
 * @module com.alterian.ja.model/AUTHGetClientLoginsDefaultResponse
 * @version 6.35.0
 */
class AUTHGetClientLoginsDefaultResponse {
    /**
     * Constructs a new <code>AUTHGetClientLoginsDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/AUTHGetClientLoginsDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        AUTHGetClientLoginsDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AUTHGetClientLoginsDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/AUTHGetClientLoginsDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/AUTHGetClientLoginsDefaultResponse} The populated <code>AUTHGetClientLoginsDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AUTHGetClientLoginsDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [LoginInfo]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AUTHGetClientLoginsDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AUTHGetClientLoginsDefaultResponse</code>.
     */
 ...
 */
AUTHGetClientLoginsDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
AUTHGetClientLoginsDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
AUTHGetClientLoginsDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
AUTHGetClientLoginsDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/LoginInfo>} Result
 */
AUTHGetClientLoginsDefaultResponse.prototype['Result'] = undefined;
...
export default AUTHGetClientLoginsDefaultResponse;
