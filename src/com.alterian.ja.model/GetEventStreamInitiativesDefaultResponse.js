...
/**
 * The GetEventStreamInitiativesDefaultResponse model module.
 * @module com.alterian.ja.model/GetEventStreamInitiativesDefaultResponse
 * @version 6.35.0
 */
class GetEventStreamInitiativesDefaultResponse {
    /**
     * Constructs a new <code>GetEventStreamInitiativesDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetEventStreamInitiativesDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetEventStreamInitiativesDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetEventStreamInitiativesDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetEventStreamInitiativesDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetEventStreamInitiativesDefaultResponse} The populated <code>GetEventStreamInitiativesDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetEventStreamInitiativesDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [Initiative]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetEventStreamInitiativesDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetEventStreamInitiativesDefaultResponse</code>.
     */
 ...
 */
GetEventStreamInitiativesDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetEventStreamInitiativesDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetEventStreamInitiativesDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetEventStreamInitiativesDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/Initiative>} Result
 */
GetEventStreamInitiativesDefaultResponse.prototype['Result'] = undefined;
...
export default GetEventStreamInitiativesDefaultResponse;
