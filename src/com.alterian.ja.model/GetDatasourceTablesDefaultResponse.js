...
/**
 * The GetDatasourceTablesDefaultResponse model module.
 * @module com.alterian.ja.model/GetDatasourceTablesDefaultResponse
 * @version 6.35.0
 */
class GetDatasourceTablesDefaultResponse {
    /**
     * Constructs a new <code>GetDatasourceTablesDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetDatasourceTablesDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetDatasourceTablesDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetDatasourceTablesDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetDatasourceTablesDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetDatasourceTablesDefaultResponse} The populated <code>GetDatasourceTablesDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDatasourceTablesDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [ALDataSourceTable]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetDatasourceTablesDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDatasourceTablesDefaultResponse</code>.
     */
 ...
 */
GetDatasourceTablesDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetDatasourceTablesDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetDatasourceTablesDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetDatasourceTablesDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/ALDataSourceTable>} Result
 */
GetDatasourceTablesDefaultResponse.prototype['Result'] = undefined;
...
export default GetDatasourceTablesDefaultResponse;
