...
/**
 * The GetFolderDefaultResponse model module.
 * @module com.alterian.ja.model/GetFolderDefaultResponse
 * @version 6.35.0
 */
class GetFolderDefaultResponse {
    /**
     * Constructs a new <code>GetFolderDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetFolderDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetFolderDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetFolderDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetFolderDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetFolderDefaultResponse} The populated <code>GetFolderDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetFolderDefaultResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetFolderDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetFolderDefaultResponse</code>.
     */
 ...
 */
GetFolderDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetFolderDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetFolderDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetFolderDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.ja.model/Folder} Result
 */
GetFolderDefaultResponse.prototype['Result'] = undefined;
...
export default GetFolderDefaultResponse;
