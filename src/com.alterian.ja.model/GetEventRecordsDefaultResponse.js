...
/**
 * The GetEventRecordsDefaultResponse model module.
 * @module com.alterian.ja.model/GetEventRecordsDefaultResponse
 * @version 6.35.0
 */
class GetEventRecordsDefaultResponse {
    /**
     * Constructs a new <code>GetEventRecordsDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetEventRecordsDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetEventRecordsDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetEventRecordsDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetEventRecordsDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetEventRecordsDefaultResponse} The populated <code>GetEventRecordsDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetEventRecordsDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = RecordData.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetEventRecordsDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetEventRecordsDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          RecordData.validateJSON(data['Result']);
        }
 ...
 */
GetEventRecordsDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetEventRecordsDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetEventRecordsDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetEventRecordsDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.ja.model/RecordData} Result
 */
GetEventRecordsDefaultResponse.prototype['Result'] = undefined;
...
export default GetEventRecordsDefaultResponse;
