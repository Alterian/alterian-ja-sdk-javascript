...
/**
 * The GetDataSourceAttributesDefaultResponse model module.
 * @module com.alterian.ja.model/GetDataSourceAttributesDefaultResponse
 * @version 6.35.0
 */
class GetDataSourceAttributesDefaultResponse {
    /**
     * Constructs a new <code>GetDataSourceAttributesDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetDataSourceAttributesDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetDataSourceAttributesDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetDataSourceAttributesDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetDataSourceAttributesDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetDataSourceAttributesDefaultResponse} The populated <code>GetDataSourceAttributesDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDataSourceAttributesDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [DatasourceAttribute]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetDataSourceAttributesDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDataSourceAttributesDefaultResponse</code>.
     */
 ...
 */
GetDataSourceAttributesDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetDataSourceAttributesDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetDataSourceAttributesDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetDataSourceAttributesDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/DatasourceAttribute>} Result
 */
GetDataSourceAttributesDefaultResponse.prototype['Result'] = undefined;
...
export default GetDataSourceAttributesDefaultResponse;
