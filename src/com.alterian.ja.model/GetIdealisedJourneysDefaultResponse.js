...
import IdealisedJourney from './IdealisedJourney';
import OperationResult from './OperationResult';

/**
 * The GetIdealisedJourneysDefaultResponse model module.
 * @module com.alterian.ja.model/GetIdealisedJourneysDefaultResponse
 * @version 6.35.0
 */
class GetIdealisedJourneysDefaultResponse {
    /**
     * Constructs a new <code>GetIdealisedJourneysDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetIdealisedJourneysDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetIdealisedJourneysDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetIdealisedJourneysDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetIdealisedJourneysDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetIdealisedJourneysDefaultResponse} The populated <code>GetIdealisedJourneysDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetIdealisedJourneysDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [IdealisedJourney]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetIdealisedJourneysDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetIdealisedJourneysDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
            ...
            for (const item of data['Result']) {
                IdealisedJourney.validateJSON(item);
            };
        }
 ...
 */
GetIdealisedJourneysDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetIdealisedJourneysDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetIdealisedJourneysDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetIdealisedJourneysDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/IdealisedJourney>} Result
 */
GetIdealisedJourneysDefaultResponse.prototype['Result'] = undefined;
...
export default GetIdealisedJourneysDefaultResponse;
