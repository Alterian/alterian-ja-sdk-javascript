...
/**
 * The EMGetCreativeDefaultResponse model module.
 * @module com.alterian.ja.model/EMGetCreativeDefaultResponse
 * @version 6.35.0
 */
class EMGetCreativeDefaultResponse {
    /**
     * Constructs a new <code>EMGetCreativeDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/EMGetCreativeDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        EMGetCreativeDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EMGetCreativeDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/EMGetCreativeDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/EMGetCreativeDefaultResponse} The populated <code>EMGetCreativeDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EMGetCreativeDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = EMDocument.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EMGetCreativeDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EMGetCreativeDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          EMDocument.validateJSON(data['Result']);
        }
 ...
 */
EMGetCreativeDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
EMGetCreativeDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
EMGetCreativeDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
EMGetCreativeDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.ja.model/EMDocument} Result
 */
EMGetCreativeDefaultResponse.prototype['Result'] = undefined;
...
export default EMGetCreativeDefaultResponse;
