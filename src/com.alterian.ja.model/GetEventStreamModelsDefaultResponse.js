...
/**
 * The GetEventStreamModelsDefaultResponse model module.
 * @module com.alterian.ja.model/GetEventStreamModelsDefaultResponse
 * @version 6.35.0
 */
class GetEventStreamModelsDefaultResponse {
    /**
     * Constructs a new <code>GetEventStreamModelsDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetEventStreamModelsDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetEventStreamModelsDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetEventStreamModelsDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetEventStreamModelsDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetEventStreamModelsDefaultResponse} The populated <code>GetEventStreamModelsDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetEventStreamModelsDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [EventStreamModel]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetEventStreamModelsDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetEventStreamModelsDefaultResponse</code>.
     */
 ...
 */
GetEventStreamModelsDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetEventStreamModelsDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetEventStreamModelsDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetEventStreamModelsDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/EventStreamModel>} Result
 */
GetEventStreamModelsDefaultResponse.prototype['Result'] = undefined;
...
export default GetEventStreamModelsDefaultResponse;
