...
import ALDataSourceType from './ALDataSourceType';
import APICursor from './APICursor';
import OperationResult from './OperationResult';

/**
 * The GetDataSourceTypesDefaultResponse model module.
 * @module com.alterian.ja.model/GetDataSourceTypesDefaultResponse
 * @version 6.35.0
 */
class GetDataSourceTypesDefaultResponse {
    /**
     * Constructs a new <code>GetDataSourceTypesDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetDataSourceTypesDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetDataSourceTypesDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetDataSourceTypesDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetDataSourceTypesDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetDataSourceTypesDefaultResponse} The populated <code>GetDataSourceTypesDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDataSourceTypesDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [ALDataSourceType]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetDataSourceTypesDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDataSourceTypesDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
            ...
            for (const item of data['Result']) {
                ALDataSourceType.validateJSON(item);
            };
        }
 ...
 */
GetDataSourceTypesDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetDataSourceTypesDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetDataSourceTypesDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetDataSourceTypesDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/ALDataSourceType>} Result
 */
GetDataSourceTypesDefaultResponse.prototype['Result'] = undefined;
...
export default GetDataSourceTypesDefaultResponse;
