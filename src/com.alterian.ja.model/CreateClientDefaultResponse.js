...
/**
 * The CreateClientDefaultResponse model module.
 * @module com.alterian.ja.model/CreateClientDefaultResponse
 * @version 6.35.0
 */
class CreateClientDefaultResponse {
    /**
     * Constructs a new <code>CreateClientDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/CreateClientDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        CreateClientDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateClientDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/CreateClientDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/CreateClientDefaultResponse} The populated <code>CreateClientDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateClientDefaultResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateClientDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateClientDefaultResponse</code>.
     */
 ...
 */
CreateClientDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
CreateClientDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
CreateClientDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
CreateClientDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Number} Result
 */
CreateClientDefaultResponse.prototype['Result'] = undefined;
...
export default CreateClientDefaultResponse;
