...
import IDatasourceObject from './IDatasourceObject';
import OperationResult from './OperationResult';

/**
 * The GetDataSourceItemsDefaultResponse model module.
 * @module com.alterian.ja.model/GetDataSourceItemsDefaultResponse
 * @version 6.35.0
 */
class GetDataSourceItemsDefaultResponse {
    /**
     * Constructs a new <code>GetDataSourceItemsDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetDataSourceItemsDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetDataSourceItemsDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetDataSourceItemsDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetDataSourceItemsDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetDataSourceItemsDefaultResponse} The populated <code>GetDataSourceItemsDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDataSourceItemsDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [IDatasourceObject]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetDataSourceItemsDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDataSourceItemsDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
            ...
            for (const item of data['Result']) {
                IDatasourceObject.validateJSON(item);
            };
        }
 ...
 */
GetDataSourceItemsDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetDataSourceItemsDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetDataSourceItemsDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetDataSourceItemsDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/IDatasourceObject>} Result
 */
GetDataSourceItemsDefaultResponse.prototype['Result'] = undefined;
...
export default GetDataSourceItemsDefaultResponse;
