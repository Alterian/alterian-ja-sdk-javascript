...
import ALClientSet from './ALClientSet';
import APICursor from './APICursor';
import OperationResult from './OperationResult';

/**
 * The GetClientSetsDefaultResponse model module.
 * @module com.alterian.ja.model/GetClientSetsDefaultResponse
 * @version 6.35.0
 */
class GetClientSetsDefaultResponse {
    /**
     * Constructs a new <code>GetClientSetsDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetClientSetsDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetClientSetsDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetClientSetsDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetClientSetsDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetClientSetsDefaultResponse} The populated <code>GetClientSetsDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetClientSetsDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [ALClientSet]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetClientSetsDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetClientSetsDefaultResponse</code>.
     */
 ...
 */
GetClientSetsDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetClientSetsDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetClientSetsDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetClientSetsDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/ALClientSet>} Result
 */
GetClientSetsDefaultResponse.prototype['Result'] = undefined;
...
export default GetClientSetsDefaultResponse;
