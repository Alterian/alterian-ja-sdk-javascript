...
import EMFoldersDTO from './EMFoldersDTO';
import OperationResult from './OperationResult';

/**
 * The EMGetFoldersLazyDefaultResponse model module.
 * @module com.alterian.ja.model/EMGetFoldersLazyDefaultResponse
 * @version 6.35.0
 */
class EMGetFoldersLazyDefaultResponse {
    /**
     * Constructs a new <code>EMGetFoldersLazyDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/EMGetFoldersLazyDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        EMGetFoldersLazyDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EMGetFoldersLazyDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/EMGetFoldersLazyDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/EMGetFoldersLazyDefaultResponse} The populated <code>EMGetFoldersLazyDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EMGetFoldersLazyDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = EMFoldersDTO.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EMGetFoldersLazyDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EMGetFoldersLazyDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          EMFoldersDTO.validateJSON(data['Result']);
        }
 ...
 */
EMGetFoldersLazyDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
EMGetFoldersLazyDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
EMGetFoldersLazyDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
EMGetFoldersLazyDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.ja.model/EMFoldersDTO} Result
 */
EMGetFoldersLazyDefaultResponse.prototype['Result'] = undefined;
...
export default EMGetFoldersLazyDefaultResponse;
