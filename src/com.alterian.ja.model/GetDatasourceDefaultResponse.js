...
/**
 * The GetDatasourceDefaultResponse model module.
 * @module com.alterian.ja.model/GetDatasourceDefaultResponse
 * @version 6.35.0
 */
class GetDatasourceDefaultResponse {
    /**
     * Constructs a new <code>GetDatasourceDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetDatasourceDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetDatasourceDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetDatasourceDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetDatasourceDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetDatasourceDefaultResponse} The populated <code>GetDatasourceDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDatasourceDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ALDataSource.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetDatasourceDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDatasourceDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          ALDataSource.validateJSON(data['Result']);
        }
 ...
 */
GetDatasourceDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetDatasourceDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetDatasourceDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetDatasourceDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.ja.model/ALDataSource} Result
 */
GetDatasourceDefaultResponse.prototype['Result'] = undefined;
...
export default GetDatasourceDefaultResponse;
