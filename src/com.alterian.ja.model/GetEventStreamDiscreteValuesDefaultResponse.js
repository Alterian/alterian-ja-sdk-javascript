...
/**
 * The GetEventStreamDiscreteValuesDefaultResponse model module.
 * @module com.alterian.ja.model/GetEventStreamDiscreteValuesDefaultResponse
 * @version 6.35.0
 */
class GetEventStreamDiscreteValuesDefaultResponse {
    /**
     * Constructs a new <code>GetEventStreamDiscreteValuesDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetEventStreamDiscreteValuesDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetEventStreamDiscreteValuesDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetEventStreamDiscreteValuesDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetEventStreamDiscreteValuesDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetEventStreamDiscreteValuesDefaultResponse} The populated <code>GetEventStreamDiscreteValuesDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetEventStreamDiscreteValuesDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [DiscreteValue]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetEventStreamDiscreteValuesDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetEventStreamDiscreteValuesDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
            ...
            for (const item of data['Result']) {
                DiscreteValue.validateJSON(item);
            };
        }
 ...
 */
GetEventStreamDiscreteValuesDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetEventStreamDiscreteValuesDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetEventStreamDiscreteValuesDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetEventStreamDiscreteValuesDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/DiscreteValue>} Result
 */
GetEventStreamDiscreteValuesDefaultResponse.prototype['Result'] = undefined;
...
export default GetEventStreamDiscreteValuesDefaultResponse;
