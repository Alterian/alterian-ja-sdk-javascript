...
import DMCreativeDTO from './DMCreativeDTO';
import OperationResult from './OperationResult';

/**
 * The EMGetCreativesDefaultResponse model module.
 * @module com.alterian.ja.model/EMGetCreativesDefaultResponse
 * @version 6.35.0
 */
class EMGetCreativesDefaultResponse {
    /**
     * Constructs a new <code>EMGetCreativesDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/EMGetCreativesDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        EMGetCreativesDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EMGetCreativesDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/EMGetCreativesDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/EMGetCreativesDefaultResponse} The populated <code>EMGetCreativesDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EMGetCreativesDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [DMCreativeDTO]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EMGetCreativesDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EMGetCreativesDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
            ...
            for (const item of data['Result']) {
                DMCreativeDTO.validateJSON(item);
            };
        }
 ...
 */
EMGetCreativesDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
EMGetCreativesDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
EMGetCreativesDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
EMGetCreativesDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/DMCreativeDTO>} Result
 */
EMGetCreativesDefaultResponse.prototype['Result'] = undefined;
...
export default EMGetCreativesDefaultResponse;
