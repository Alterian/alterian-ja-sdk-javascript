...
/**
 * The GetEventStreamsDefaultResponse model module.
 * @module com.alterian.ja.model/GetEventStreamsDefaultResponse
 * @version 6.35.0
 */
class GetEventStreamsDefaultResponse {
    /**
     * Constructs a new <code>GetEventStreamsDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetEventStreamsDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetEventStreamsDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetEventStreamsDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetEventStreamsDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetEventStreamsDefaultResponse} The populated <code>GetEventStreamsDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetEventStreamsDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [EventStream]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetEventStreamsDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetEventStreamsDefaultResponse</code>.
     */
 ...
 */
GetEventStreamsDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetEventStreamsDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetEventStreamsDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetEventStreamsDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/EventStream>} Result
 */
GetEventStreamsDefaultResponse.prototype['Result'] = undefined;
...
export default GetEventStreamsDefaultResponse;
