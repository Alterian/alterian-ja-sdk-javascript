...
/**
 * The GetBusinessGoalsDefaultResponse model module.
 * @module com.alterian.ja.model/GetBusinessGoalsDefaultResponse
 * @version 6.35.0
 */
class GetBusinessGoalsDefaultResponse {
    /**
     * Constructs a new <code>GetBusinessGoalsDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetBusinessGoalsDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetBusinessGoalsDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetBusinessGoalsDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetBusinessGoalsDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetBusinessGoalsDefaultResponse} The populated <code>GetBusinessGoalsDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetBusinessGoalsDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [BusinessGoal]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetBusinessGoalsDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBusinessGoalsDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
            ...
            for (const item of data['Result']) {
                BusinessGoal.validateJSON(item);
            };
        }
 ...
 */
GetBusinessGoalsDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetBusinessGoalsDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetBusinessGoalsDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetBusinessGoalsDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/BusinessGoal>} Result
 */
GetBusinessGoalsDefaultResponse.prototype['Result'] = undefined;
...
export default GetBusinessGoalsDefaultResponse;
