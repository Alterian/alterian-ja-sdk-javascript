...
import ALProcessApplication from './ALProcessApplication';
import APICursor from './APICursor';
import OperationResult from './OperationResult';

/**
 * The GetProcessApplicationsDefaultResponse model module.
 * @module com.alterian.ja.model/GetProcessApplicationsDefaultResponse
 * @version 6.35.0
 */
class GetProcessApplicationsDefaultResponse {
    /**
     * Constructs a new <code>GetProcessApplicationsDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetProcessApplicationsDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetProcessApplicationsDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetProcessApplicationsDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetProcessApplicationsDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetProcessApplicationsDefaultResponse} The populated <code>GetProcessApplicationsDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetProcessApplicationsDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [ALProcessApplication]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetProcessApplicationsDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetProcessApplicationsDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
            ...
            for (const item of data['Result']) {
                ALProcessApplication.validateJSON(item);
            };
        }
 ...
 */
GetProcessApplicationsDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetProcessApplicationsDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetProcessApplicationsDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetProcessApplicationsDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/ALProcessApplication>} Result
 */
GetProcessApplicationsDefaultResponse.prototype['Result'] = undefined;
...
export default GetProcessApplicationsDefaultResponse;
