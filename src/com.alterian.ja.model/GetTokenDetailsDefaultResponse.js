...
import CMTokenInformation from './CMTokenInformation';
import OperationResult from './OperationResult';

/**
 * The GetTokenDetailsDefaultResponse model module.
 * @module com.alterian.ja.model/GetTokenDetailsDefaultResponse
 * @version 6.35.0
 */
class GetTokenDetailsDefaultResponse {
    /**
     * Constructs a new <code>GetTokenDetailsDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetTokenDetailsDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetTokenDetailsDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetTokenDetailsDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetTokenDetailsDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetTokenDetailsDefaultResponse} The populated <code>GetTokenDetailsDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetTokenDetailsDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = CMTokenInformation.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetTokenDetailsDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTokenDetailsDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          CMTokenInformation.validateJSON(data['Result']);
        }
 ...
 */
GetTokenDetailsDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetTokenDetailsDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetTokenDetailsDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetTokenDetailsDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.ja.model/CMTokenInformation} Result
 */
GetTokenDetailsDefaultResponse.prototype['Result'] = undefined;
...
export default GetTokenDetailsDefaultResponse;
