...
/**
 * The GetUsersDefaultResponse model module.
 * @module com.alterian.ja.model/GetUsersDefaultResponse
 * @version 6.35.0
 */
class GetUsersDefaultResponse {
    /**
     * Constructs a new <code>GetUsersDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetUsersDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetUsersDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetUsersDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetUsersDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetUsersDefaultResponse} The populated <code>GetUsersDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetUsersDefaultResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetUsersDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetUsersDefaultResponse</code>.
     */
 ...
 */
GetUsersDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetUsersDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetUsersDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetUsersDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<Object>} Result
 */
GetUsersDefaultResponse.prototype['Result'] = undefined;
...
export default GetUsersDefaultResponse;
