...
/**
 * The AUTHChangePasswordDefaultResponse model module.
 * @module com.alterian.ja.model/AUTHChangePasswordDefaultResponse
 * @version 6.35.0
 */
class AUTHChangePasswordDefaultResponse {
    /**
     * Constructs a new <code>AUTHChangePasswordDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/AUTHChangePasswordDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        AUTHChangePasswordDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AUTHChangePasswordDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/AUTHChangePasswordDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/AUTHChangePasswordDefaultResponse} The populated <code>AUTHChangePasswordDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AUTHChangePasswordDefaultResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>AUTHChangePasswordDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AUTHChangePasswordDefaultResponse</code>.
     */
 ...
 */
AUTHChangePasswordDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
AUTHChangePasswordDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
AUTHChangePasswordDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
AUTHChangePasswordDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Boolean} Result
 */
AUTHChangePasswordDefaultResponse.prototype['Result'] = undefined;
...
export default AUTHChangePasswordDefaultResponse;
