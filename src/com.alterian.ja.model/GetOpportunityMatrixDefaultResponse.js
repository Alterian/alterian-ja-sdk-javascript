...
/**
 * The GetOpportunityMatrixDefaultResponse model module.
 * @module com.alterian.ja.model/GetOpportunityMatrixDefaultResponse
 * @version 6.35.0
 */
class GetOpportunityMatrixDefaultResponse {
    /**
     * Constructs a new <code>GetOpportunityMatrixDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetOpportunityMatrixDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetOpportunityMatrixDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetOpportunityMatrixDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetOpportunityMatrixDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetOpportunityMatrixDefaultResponse} The populated <code>GetOpportunityMatrixDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetOpportunityMatrixDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [OpportunityMatrix]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetOpportunityMatrixDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetOpportunityMatrixDefaultResponse</code>.
     */
 ...
 */
GetOpportunityMatrixDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetOpportunityMatrixDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetOpportunityMatrixDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetOpportunityMatrixDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/OpportunityMatrix>} Result
 */
GetOpportunityMatrixDefaultResponse.prototype['Result'] = undefined;
...
export default GetOpportunityMatrixDefaultResponse;
