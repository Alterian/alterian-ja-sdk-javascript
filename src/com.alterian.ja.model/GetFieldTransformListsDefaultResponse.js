...
/**
 * The GetFieldTransformListsDefaultResponse model module.
 * @module com.alterian.ja.model/GetFieldTransformListsDefaultResponse
 * @version 6.35.0
 */
class GetFieldTransformListsDefaultResponse {
    /**
     * Constructs a new <code>GetFieldTransformListsDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetFieldTransformListsDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetFieldTransformListsDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetFieldTransformListsDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetFieldTransformListsDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetFieldTransformListsDefaultResponse} The populated <code>GetFieldTransformListsDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetFieldTransformListsDefaultResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetFieldTransformListsDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetFieldTransformListsDefaultResponse</code>.
     */
 ...
 */
GetFieldTransformListsDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetFieldTransformListsDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetFieldTransformListsDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetFieldTransformListsDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/Transform>} Result
 */
GetFieldTransformListsDefaultResponse.prototype['Result'] = undefined;
...
export default GetFieldTransformListsDefaultResponse;
