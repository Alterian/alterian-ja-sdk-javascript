...
import WebSpoonStatus from './WebSpoonStatus';

/**
 * The CreateWebSpoonDefaultResponse model module.
 * @module com.alterian.ja.model/CreateWebSpoonDefaultResponse
 * @version 6.35.0
 */
class CreateWebSpoonDefaultResponse {
    /**
     * Constructs a new <code>CreateWebSpoonDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/CreateWebSpoonDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        CreateWebSpoonDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateWebSpoonDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/CreateWebSpoonDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/CreateWebSpoonDefaultResponse} The populated <code>CreateWebSpoonDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateWebSpoonDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = WebSpoonStatus.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateWebSpoonDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateWebSpoonDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          WebSpoonStatus.validateJSON(data['Result']);
        }
 ...
 */
CreateWebSpoonDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
CreateWebSpoonDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
CreateWebSpoonDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
CreateWebSpoonDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.ja.model/WebSpoonStatus} Result
 */
CreateWebSpoonDefaultResponse.prototype['Result'] = undefined;
...
export default CreateWebSpoonDefaultResponse;
