...
/**
 * The GetDataSourcesDefaultResponse model module.
 * @module com.alterian.ja.model/GetDataSourcesDefaultResponse
 * @version 6.35.0
 */
class GetDataSourcesDefaultResponse {
    /**
     * Constructs a new <code>GetDataSourcesDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetDataSourcesDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetDataSourcesDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetDataSourcesDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetDataSourcesDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetDataSourcesDefaultResponse} The populated <code>GetDataSourcesDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDataSourcesDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [ALDataSource]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetDataSourcesDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDataSourcesDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
            ...
            for (const item of data['Result']) {
                ALDataSource.validateJSON(item);
            };
        }
 ...
 */
GetDataSourcesDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetDataSourcesDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetDataSourcesDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetDataSourcesDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/ALDataSource>} Result
 */
GetDataSourcesDefaultResponse.prototype['Result'] = undefined;
...
export default GetDataSourcesDefaultResponse;
