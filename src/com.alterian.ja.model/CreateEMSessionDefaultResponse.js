...
/**
 * The CreateEMSessionDefaultResponse model module.
 * @module com.alterian.ja.model/CreateEMSessionDefaultResponse
 * @version 6.35.0
 */
class CreateEMSessionDefaultResponse {
    /**
     * Constructs a new <code>CreateEMSessionDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/CreateEMSessionDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        CreateEMSessionDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateEMSessionDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/CreateEMSessionDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/CreateEMSessionDefaultResponse} The populated <code>CreateEMSessionDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateEMSessionDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApplicationDetails.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateEMSessionDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateEMSessionDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          ApplicationDetails.validateJSON(data['Result']);
        }
 ...
 */
CreateEMSessionDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
CreateEMSessionDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
CreateEMSessionDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
CreateEMSessionDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.ja.model/ApplicationDetails} Result
 */
CreateEMSessionDefaultResponse.prototype['Result'] = undefined;
...
export default CreateEMSessionDefaultResponse;
