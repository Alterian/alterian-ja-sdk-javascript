...
/**
 * The GetGroupsDefaultResponse model module.
 * @module com.alterian.ja.model/GetGroupsDefaultResponse
 * @version 6.35.0
 */
class GetGroupsDefaultResponse {
    /**
     * Constructs a new <code>GetGroupsDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetGroupsDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetGroupsDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetGroupsDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetGroupsDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetGroupsDefaultResponse} The populated <code>GetGroupsDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetGroupsDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [ALUserGroup]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetGroupsDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetGroupsDefaultResponse</code>.
     */
 ...
 */
GetGroupsDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetGroupsDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetGroupsDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetGroupsDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/ALUserGroup>} Result
 */
GetGroupsDefaultResponse.prototype['Result'] = undefined;
...
export default GetGroupsDefaultResponse;
