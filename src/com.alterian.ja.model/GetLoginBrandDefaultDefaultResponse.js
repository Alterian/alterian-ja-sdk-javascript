...
/**
 * The GetLoginBrandDefaultDefaultResponse model module.
 * @module com.alterian.ja.model/GetLoginBrandDefaultDefaultResponse
 * @version 6.35.0
 */
class GetLoginBrandDefaultDefaultResponse {
    /**
     * Constructs a new <code>GetLoginBrandDefaultDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetLoginBrandDefaultDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetLoginBrandDefaultDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetLoginBrandDefaultDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetLoginBrandDefaultDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetLoginBrandDefaultDefaultResponse} The populated <code>GetLoginBrandDefaultDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetLoginBrandDefaultDefaultResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetLoginBrandDefaultDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLoginBrandDefaultDefaultResponse</code>.
     */
 ...
 */
GetLoginBrandDefaultDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetLoginBrandDefaultDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetLoginBrandDefaultDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetLoginBrandDefaultDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Number} Result
 */
GetLoginBrandDefaultDefaultResponse.prototype['Result'] = undefined;
...
export default GetLoginBrandDefaultDefaultResponse;
