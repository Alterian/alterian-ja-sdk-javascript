...
/**
 * The FieldTransformList model module.
 * @module com.alterian.ja.model/FieldTransformList
 * @version 6.35.0
 */
class FieldTransformList {
    /**
     * Constructs a new <code>FieldTransformList</code>.
     * 
     * @alias module:com.alterian.ja.model/FieldTransformList
     */
    constructor() { 
        
        FieldTransformList.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FieldTransformList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/FieldTransformList} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/FieldTransformList} The populated <code>FieldTransformList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FieldTransformList();
    ...
    /**
     * Validates the JSON data with respect to <code>FieldTransformList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FieldTransformList</code>.
     */
 ...
 * @member {String} Name
 */
FieldTransformList.prototype['Name'] = undefined;

/**
 * 
 * @member {Number} Id
 */
FieldTransformList.prototype['Id'] = undefined;

/**
 * 
 * @member {Number} Version
 */
FieldTransformList.prototype['Version'] = undefined;

/**
 * 
 * @member {String} JSONTransforms
 */
FieldTransformList.prototype['JSONTransforms'] = undefined;

/**
 * 
 * @member {String} Metadata
 */
FieldTransformList.prototype['Metadata'] = undefined;

/**
 * 
 * @member {Array.<module:com.alterian.ja.model/ColumnPublishedTransform>} PublishedVersions
 */
FieldTransformList.prototype['PublishedVersions'] = undefined;
...
export default FieldTransformList;
