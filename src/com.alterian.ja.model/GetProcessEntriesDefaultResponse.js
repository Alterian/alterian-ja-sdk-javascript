...
import ALProcess from './ALProcess';
import APICursor from './APICursor';
import OperationResult from './OperationResult';

/**
 * The GetProcessEntriesDefaultResponse model module.
 * @module com.alterian.ja.model/GetProcessEntriesDefaultResponse
 * @version 6.35.0
 */
class GetProcessEntriesDefaultResponse {
    /**
     * Constructs a new <code>GetProcessEntriesDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetProcessEntriesDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetProcessEntriesDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetProcessEntriesDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetProcessEntriesDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetProcessEntriesDefaultResponse} The populated <code>GetProcessEntriesDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetProcessEntriesDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [ALProcess]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetProcessEntriesDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetProcessEntriesDefaultResponse</code>.
     */
 ...
 */
GetProcessEntriesDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetProcessEntriesDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetProcessEntriesDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetProcessEntriesDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/ALProcess>} Result
 */
GetProcessEntriesDefaultResponse.prototype['Result'] = undefined;
...
export default GetProcessEntriesDefaultResponse;
