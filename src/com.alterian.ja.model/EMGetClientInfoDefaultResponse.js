...
/**
 * The EMGetClientInfoDefaultResponse model module.
 * @module com.alterian.ja.model/EMGetClientInfoDefaultResponse
 * @version 6.35.0
 */
class EMGetClientInfoDefaultResponse {
    /**
     * Constructs a new <code>EMGetClientInfoDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/EMGetClientInfoDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        EMGetClientInfoDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EMGetClientInfoDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/EMGetClientInfoDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/EMGetClientInfoDefaultResponse} The populated <code>EMGetClientInfoDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EMGetClientInfoDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = DMClient.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EMGetClientInfoDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EMGetClientInfoDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          DMClient.validateJSON(data['Result']);
        }
 ...
 */
EMGetClientInfoDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
EMGetClientInfoDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
EMGetClientInfoDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
EMGetClientInfoDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.ja.model/DMClient} Result
 */
EMGetClientInfoDefaultResponse.prototype['Result'] = undefined;
...
export default EMGetClientInfoDefaultResponse;
