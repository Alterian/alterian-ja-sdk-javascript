...
/**
 * The GetAvailablePermissionsDefaultResponse model module.
 * @module com.alterian.ja.model/GetAvailablePermissionsDefaultResponse
 * @version 6.35.0
 */
class GetAvailablePermissionsDefaultResponse {
    /**
     * Constructs a new <code>GetAvailablePermissionsDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetAvailablePermissionsDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetAvailablePermissionsDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetAvailablePermissionsDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetAvailablePermissionsDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetAvailablePermissionsDefaultResponse} The populated <code>GetAvailablePermissionsDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetAvailablePermissionsDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [Permission]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetAvailablePermissionsDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetAvailablePermissionsDefaultResponse</code>.
     */
 ...
 */
GetAvailablePermissionsDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetAvailablePermissionsDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetAvailablePermissionsDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetAvailablePermissionsDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/Permission>} Result
 */
GetAvailablePermissionsDefaultResponse.prototype['Result'] = undefined;
...
export default GetAvailablePermissionsDefaultResponse;
