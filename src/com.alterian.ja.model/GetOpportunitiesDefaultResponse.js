...
/**
 * The GetOpportunitiesDefaultResponse model module.
 * @module com.alterian.ja.model/GetOpportunitiesDefaultResponse
 * @version 6.35.0
 */
class GetOpportunitiesDefaultResponse {
    /**
     * Constructs a new <code>GetOpportunitiesDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetOpportunitiesDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetOpportunitiesDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetOpportunitiesDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetOpportunitiesDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetOpportunitiesDefaultResponse} The populated <code>GetOpportunitiesDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetOpportunitiesDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [Opportunity]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetOpportunitiesDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetOpportunitiesDefaultResponse</code>.
     */
 ...
 */
GetOpportunitiesDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetOpportunitiesDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetOpportunitiesDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetOpportunitiesDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/Opportunity>} Result
 */
GetOpportunitiesDefaultResponse.prototype['Result'] = undefined;
...
export default GetOpportunitiesDefaultResponse;
