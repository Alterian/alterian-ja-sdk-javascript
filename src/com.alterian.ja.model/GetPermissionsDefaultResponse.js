...
/**
 * The GetPermissionsDefaultResponse model module.
 * @module com.alterian.ja.model/GetPermissionsDefaultResponse
 * @version 6.35.0
 */
class GetPermissionsDefaultResponse {
    /**
     * Constructs a new <code>GetPermissionsDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetPermissionsDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetPermissionsDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetPermissionsDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetPermissionsDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetPermissionsDefaultResponse} The populated <code>GetPermissionsDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPermissionsDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [ALPermission]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPermissionsDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPermissionsDefaultResponse</code>.
     */
 ...
 */
GetPermissionsDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetPermissionsDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetPermissionsDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetPermissionsDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/ALPermission>} Result
 */
GetPermissionsDefaultResponse.prototype['Result'] = undefined;
...
export default GetPermissionsDefaultResponse;
