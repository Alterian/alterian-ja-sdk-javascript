...
/**
 * The EMGetClientGroupUsersDefaultResponse model module.
 * @module com.alterian.ja.model/EMGetClientGroupUsersDefaultResponse
 * @version 6.35.0
 */
class EMGetClientGroupUsersDefaultResponse {
    /**
     * Constructs a new <code>EMGetClientGroupUsersDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/EMGetClientGroupUsersDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        EMGetClientGroupUsersDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EMGetClientGroupUsersDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/EMGetClientGroupUsersDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/EMGetClientGroupUsersDefaultResponse} The populated <code>EMGetClientGroupUsersDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EMGetClientGroupUsersDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [DMUser]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EMGetClientGroupUsersDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EMGetClientGroupUsersDefaultResponse</code>.
     */
 ...
 */
EMGetClientGroupUsersDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
EMGetClientGroupUsersDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
EMGetClientGroupUsersDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
EMGetClientGroupUsersDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/DMUser>} Result
 */
EMGetClientGroupUsersDefaultResponse.prototype['Result'] = undefined;
...
export default EMGetClientGroupUsersDefaultResponse;
