...
/**
 * The GetDataSourceMappingsDefaultResponse model module.
 * @module com.alterian.ja.model/GetDataSourceMappingsDefaultResponse
 * @version 6.35.0
 */
class GetDataSourceMappingsDefaultResponse {
    /**
     * Constructs a new <code>GetDataSourceMappingsDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetDataSourceMappingsDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetDataSourceMappingsDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetDataSourceMappingsDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetDataSourceMappingsDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetDataSourceMappingsDefaultResponse} The populated <code>GetDataSourceMappingsDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDataSourceMappingsDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [DatasourceUserMapping]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetDataSourceMappingsDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDataSourceMappingsDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
            ...
            for (const item of data['Result']) {
                DatasourceUserMapping.validateJSON(item);
            };
        }
 ...
 */
GetDataSourceMappingsDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetDataSourceMappingsDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetDataSourceMappingsDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetDataSourceMappingsDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/DatasourceUserMapping>} Result
 */
GetDataSourceMappingsDefaultResponse.prototype['Result'] = undefined;
...
export default GetDataSourceMappingsDefaultResponse;
