...
import InboundAddresses from './InboundAddresses';
import OperationResult from './OperationResult';

/**
 * The EMGetInboundAddressesDefaultResponse model module.
 * @module com.alterian.ja.model/EMGetInboundAddressesDefaultResponse
 * @version 6.35.0
 */
class EMGetInboundAddressesDefaultResponse {
    /**
     * Constructs a new <code>EMGetInboundAddressesDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/EMGetInboundAddressesDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        EMGetInboundAddressesDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EMGetInboundAddressesDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/EMGetInboundAddressesDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/EMGetInboundAddressesDefaultResponse} The populated <code>EMGetInboundAddressesDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EMGetInboundAddressesDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = InboundAddresses.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EMGetInboundAddressesDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EMGetInboundAddressesDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          InboundAddresses.validateJSON(data['Result']);
        }
 ...
 */
EMGetInboundAddressesDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
EMGetInboundAddressesDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
EMGetInboundAddressesDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
EMGetInboundAddressesDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.ja.model/InboundAddresses} Result
 */
EMGetInboundAddressesDefaultResponse.prototype['Result'] = undefined;
...
export default EMGetInboundAddressesDefaultResponse;
