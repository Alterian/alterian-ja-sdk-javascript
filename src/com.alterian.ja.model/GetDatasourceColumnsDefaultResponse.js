...
/**
 * The GetDatasourceColumnsDefaultResponse model module.
 * @module com.alterian.ja.model/GetDatasourceColumnsDefaultResponse
 * @version 6.35.0
 */
class GetDatasourceColumnsDefaultResponse {
    /**
     * Constructs a new <code>GetDatasourceColumnsDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetDatasourceColumnsDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetDatasourceColumnsDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetDatasourceColumnsDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetDatasourceColumnsDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetDatasourceColumnsDefaultResponse} The populated <code>GetDatasourceColumnsDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDatasourceColumnsDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [ALDataSourceColumn]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetDatasourceColumnsDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDatasourceColumnsDefaultResponse</code>.
     */
 ...
 */
GetDatasourceColumnsDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetDatasourceColumnsDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetDatasourceColumnsDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetDatasourceColumnsDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/ALDataSourceColumn>} Result
 */
GetDatasourceColumnsDefaultResponse.prototype['Result'] = undefined;
...
export default GetDatasourceColumnsDefaultResponse;
