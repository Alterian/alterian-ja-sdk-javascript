...
import DMClientSet from './DMClientSet';
import OperationResult from './OperationResult';

/**
 * The EMGetClientSetsDefaultResponse model module.
 * @module com.alterian.ja.model/EMGetClientSetsDefaultResponse
 * @version 6.35.0
 */
class EMGetClientSetsDefaultResponse {
    /**
     * Constructs a new <code>EMGetClientSetsDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/EMGetClientSetsDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        EMGetClientSetsDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EMGetClientSetsDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/EMGetClientSetsDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/EMGetClientSetsDefaultResponse} The populated <code>EMGetClientSetsDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EMGetClientSetsDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [DMClientSet]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EMGetClientSetsDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EMGetClientSetsDefaultResponse</code>.
     */
 ...
 */
EMGetClientSetsDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
EMGetClientSetsDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
EMGetClientSetsDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
EMGetClientSetsDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/DMClientSet>} Result
 */
EMGetClientSetsDefaultResponse.prototype['Result'] = undefined;
...
export default EMGetClientSetsDefaultResponse;
