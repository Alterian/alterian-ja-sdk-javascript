...
/**
 * The ListWebSpoonDefaultResponse model module.
 * @module com.alterian.ja.model/ListWebSpoonDefaultResponse
 * @version 6.35.0
 */
class ListWebSpoonDefaultResponse {
    /**
     * Constructs a new <code>ListWebSpoonDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/ListWebSpoonDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        ListWebSpoonDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListWebSpoonDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/ListWebSpoonDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/ListWebSpoonDefaultResponse} The populated <code>ListWebSpoonDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListWebSpoonDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [WebSpoonStatus]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListWebSpoonDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListWebSpoonDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
            ...
            for (const item of data['Result']) {
                WebSpoonStatus.validateJSON(item);
            };
        }
 ...
 */
ListWebSpoonDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
ListWebSpoonDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
ListWebSpoonDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
ListWebSpoonDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/WebSpoonStatus>} Result
 */
ListWebSpoonDefaultResponse.prototype['Result'] = undefined;
...
export default ListWebSpoonDefaultResponse;
