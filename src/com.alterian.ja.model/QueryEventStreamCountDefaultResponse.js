...
/**
 * The QueryEventStreamCountDefaultResponse model module.
 * @module com.alterian.ja.model/QueryEventStreamCountDefaultResponse
 * @version 6.35.0
 */
class QueryEventStreamCountDefaultResponse {
    /**
     * Constructs a new <code>QueryEventStreamCountDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/QueryEventStreamCountDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        QueryEventStreamCountDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>QueryEventStreamCountDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/QueryEventStreamCountDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/QueryEventStreamCountDefaultResponse} The populated <code>QueryEventStreamCountDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new QueryEventStreamCountDefaultResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>QueryEventStreamCountDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>QueryEventStreamCountDefaultResponse</code>.
     */
 ...
 */
QueryEventStreamCountDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
QueryEventStreamCountDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
QueryEventStreamCountDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
QueryEventStreamCountDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Number} Result
 */
QueryEventStreamCountDefaultResponse.prototype['Result'] = undefined;
...
export default QueryEventStreamCountDefaultResponse;
