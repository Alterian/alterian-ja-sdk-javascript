...
/**
 * The GetProcessStatusDefaultResponse model module.
 * @module com.alterian.ja.model/GetProcessStatusDefaultResponse
 * @version 6.35.0
 */
class GetProcessStatusDefaultResponse {
    /**
     * Constructs a new <code>GetProcessStatusDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetProcessStatusDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetProcessStatusDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetProcessStatusDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetProcessStatusDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetProcessStatusDefaultResponse} The populated <code>GetProcessStatusDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetProcessStatusDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ProcessStatus.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetProcessStatusDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetProcessStatusDefaultResponse</code>.
     */
 ...
 */
GetProcessStatusDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetProcessStatusDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetProcessStatusDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetProcessStatusDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.ja.model/ProcessStatus} Result
 */
GetProcessStatusDefaultResponse.prototype['Result'] = undefined;
...
export default GetProcessStatusDefaultResponse;
