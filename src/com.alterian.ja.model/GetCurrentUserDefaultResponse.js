...
/**
 * The GetCurrentUserDefaultResponse model module.
 * @module com.alterian.ja.model/GetCurrentUserDefaultResponse
 * @version 6.35.0
 */
class GetCurrentUserDefaultResponse {
    /**
     * Constructs a new <code>GetCurrentUserDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetCurrentUserDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetCurrentUserDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetCurrentUserDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetCurrentUserDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetCurrentUserDefaultResponse} The populated <code>GetCurrentUserDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCurrentUserDefaultResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetCurrentUserDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCurrentUserDefaultResponse</code>.
     */
 ...
 */
GetCurrentUserDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetCurrentUserDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetCurrentUserDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetCurrentUserDefaultResponse.prototype['Cursor'] = undefined;
 ...
 */
GetCurrentUserDefaultResponse.prototype['Result'] = undefined;
...
export default GetCurrentUserDefaultResponse;
