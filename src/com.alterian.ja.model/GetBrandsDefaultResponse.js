...
/**
 * The GetBrandsDefaultResponse model module.
 * @module com.alterian.ja.model/GetBrandsDefaultResponse
 * @version 6.35.0
 */
class GetBrandsDefaultResponse {
    /**
     * Constructs a new <code>GetBrandsDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetBrandsDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetBrandsDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetBrandsDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetBrandsDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetBrandsDefaultResponse} The populated <code>GetBrandsDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetBrandsDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [ALClient]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetBrandsDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBrandsDefaultResponse</code>.
     */
 ...
 */
GetBrandsDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetBrandsDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetBrandsDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetBrandsDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/ALClient>} Result
 */
GetBrandsDefaultResponse.prototype['Result'] = undefined;
...
export default GetBrandsDefaultResponse;
