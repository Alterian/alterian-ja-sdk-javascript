...
import ALCulture from './ALCulture';
import APICursor from './APICursor';
import OperationResult from './OperationResult';

/**
 * The GetCulturesDefaultResponse model module.
 * @module com.alterian.ja.model/GetCulturesDefaultResponse
 * @version 6.35.0
 */
class GetCulturesDefaultResponse {
    /**
     * Constructs a new <code>GetCulturesDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetCulturesDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetCulturesDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetCulturesDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetCulturesDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetCulturesDefaultResponse} The populated <code>GetCulturesDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCulturesDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [ALCulture]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetCulturesDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCulturesDefaultResponse</code>.
     */
 ...
 */
GetCulturesDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetCulturesDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetCulturesDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetCulturesDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/ALCulture>} Result
 */
GetCulturesDefaultResponse.prototype['Result'] = undefined;
...
export default GetCulturesDefaultResponse;
