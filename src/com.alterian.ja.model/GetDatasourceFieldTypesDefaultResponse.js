...
import AlchemyFieldType from './AlchemyFieldType';
import OperationResult from './OperationResult';

/**
 * The GetDatasourceFieldTypesDefaultResponse model module.
 * @module com.alterian.ja.model/GetDatasourceFieldTypesDefaultResponse
 * @version 6.35.0
 */
class GetDatasourceFieldTypesDefaultResponse {
    /**
     * Constructs a new <code>GetDatasourceFieldTypesDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetDatasourceFieldTypesDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetDatasourceFieldTypesDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetDatasourceFieldTypesDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetDatasourceFieldTypesDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetDatasourceFieldTypesDefaultResponse} The populated <code>GetDatasourceFieldTypesDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDatasourceFieldTypesDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [AlchemyFieldType]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetDatasourceFieldTypesDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDatasourceFieldTypesDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
            ...
            for (const item of data['Result']) {
                AlchemyFieldType.validateJSON(item);
            };
        }
 ...
 */
GetDatasourceFieldTypesDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetDatasourceFieldTypesDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetDatasourceFieldTypesDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetDatasourceFieldTypesDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/AlchemyFieldType>} Result
 */
GetDatasourceFieldTypesDefaultResponse.prototype['Result'] = undefined;
...
export default GetDatasourceFieldTypesDefaultResponse;
