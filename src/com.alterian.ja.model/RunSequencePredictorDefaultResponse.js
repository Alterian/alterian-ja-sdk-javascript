...
import SequencePredictorResult from './SequencePredictorResult';

/**
 * The RunSequencePredictorDefaultResponse model module.
 * @module com.alterian.ja.model/RunSequencePredictorDefaultResponse
 * @version 6.35.0
 */
class RunSequencePredictorDefaultResponse {
    /**
     * Constructs a new <code>RunSequencePredictorDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/RunSequencePredictorDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        RunSequencePredictorDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RunSequencePredictorDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/RunSequencePredictorDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/RunSequencePredictorDefaultResponse} The populated <code>RunSequencePredictorDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RunSequencePredictorDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = SequencePredictorResult.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RunSequencePredictorDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RunSequencePredictorDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          SequencePredictorResult.validateJSON(data['Result']);
        }
 ...
 */
RunSequencePredictorDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
RunSequencePredictorDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
RunSequencePredictorDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
RunSequencePredictorDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.ja.model/SequencePredictorResult} Result
 */
RunSequencePredictorDefaultResponse.prototype['Result'] = undefined;
...
export default RunSequencePredictorDefaultResponse;
