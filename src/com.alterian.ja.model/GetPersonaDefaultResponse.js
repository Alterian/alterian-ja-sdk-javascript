...
/**
 * The GetPersonaDefaultResponse model module.
 * @module com.alterian.ja.model/GetPersonaDefaultResponse
 * @version 6.35.0
 */
class GetPersonaDefaultResponse {
    /**
     * Constructs a new <code>GetPersonaDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetPersonaDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetPersonaDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetPersonaDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetPersonaDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetPersonaDefaultResponse} The populated <code>GetPersonaDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPersonaDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = Persona.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPersonaDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPersonaDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          Persona.validateJSON(data['Result']);
        }
 ...
 */
GetPersonaDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetPersonaDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetPersonaDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetPersonaDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.ja.model/Persona} Result
 */
GetPersonaDefaultResponse.prototype['Result'] = undefined;
...
export default GetPersonaDefaultResponse;
