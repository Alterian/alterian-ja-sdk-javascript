...
/**
 * The GetResourcesDefaultResponse model module.
 * @module com.alterian.ja.model/GetResourcesDefaultResponse
 * @version 6.35.0
 */
class GetResourcesDefaultResponse {
    /**
     * Constructs a new <code>GetResourcesDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetResourcesDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetResourcesDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetResourcesDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetResourcesDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetResourcesDefaultResponse} The populated <code>GetResourcesDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetResourcesDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [PermissionResource]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetResourcesDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetResourcesDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
            ...
            for (const item of data['Result']) {
                PermissionResource.validateJSON(item);
            };
        }
 ...
 */
GetResourcesDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetResourcesDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetResourcesDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetResourcesDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/PermissionResource>} Result
 */
GetResourcesDefaultResponse.prototype['Result'] = undefined;
...
export default GetResourcesDefaultResponse;
