...
/**
 * The GetDataSourceEngineUserNameDefaultResponse model module.
 * @module com.alterian.ja.model/GetDataSourceEngineUserNameDefaultResponse
 * @version 6.35.0
 */
class GetDataSourceEngineUserNameDefaultResponse {
    /**
     * Constructs a new <code>GetDataSourceEngineUserNameDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetDataSourceEngineUserNameDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetDataSourceEngineUserNameDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetDataSourceEngineUserNameDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetDataSourceEngineUserNameDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetDataSourceEngineUserNameDefaultResponse} The populated <code>GetDataSourceEngineUserNameDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDataSourceEngineUserNameDefaultResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetDataSourceEngineUserNameDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDataSourceEngineUserNameDefaultResponse</code>.
     */
 ...
 */
GetDataSourceEngineUserNameDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetDataSourceEngineUserNameDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetDataSourceEngineUserNameDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetDataSourceEngineUserNameDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {String} Result
 */
GetDataSourceEngineUserNameDefaultResponse.prototype['Result'] = undefined;
...
export default GetDataSourceEngineUserNameDefaultResponse;
