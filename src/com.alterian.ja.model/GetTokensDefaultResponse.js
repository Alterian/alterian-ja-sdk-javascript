...
/**
 * The GetTokensDefaultResponse model module.
 * @module com.alterian.ja.model/GetTokensDefaultResponse
 * @version 6.35.0
 */
class GetTokensDefaultResponse {
    /**
     * Constructs a new <code>GetTokensDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetTokensDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetTokensDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetTokensDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetTokensDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetTokensDefaultResponse} The populated <code>GetTokensDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetTokensDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [CMTokenInformation]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetTokensDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTokensDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
            ...
            for (const item of data['Result']) {
                CMTokenInformation.validateJSON(item);
            };
        }
 ...
 */
GetTokensDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetTokensDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetTokensDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetTokensDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.ja.model/CMTokenInformation>} Result
 */
GetTokensDefaultResponse.prototype['Result'] = undefined;
...
export default GetTokensDefaultResponse;
