...
/**
 * The GetTimeZonesDefaultResponse model module.
 * @module com.alterian.ja.model/GetTimeZonesDefaultResponse
 * @version 6.35.0
 */
class GetTimeZonesDefaultResponse {
    /**
     * Constructs a new <code>GetTimeZonesDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetTimeZonesDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetTimeZonesDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetTimeZonesDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetTimeZonesDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetTimeZonesDefaultResponse} The populated <code>GetTimeZonesDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetTimeZonesDefaultResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetTimeZonesDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTimeZonesDefaultResponse</code>.
     */
 ...
 */
GetTimeZonesDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetTimeZonesDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetTimeZonesDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetTimeZonesDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<Object>} Result
 */
GetTimeZonesDefaultResponse.prototype['Result'] = undefined;
...
export default GetTimeZonesDefaultResponse;
