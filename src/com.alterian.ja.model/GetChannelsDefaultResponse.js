...
/**
 * The GetChannelsDefaultResponse model module.
 * @module com.alterian.ja.model/GetChannelsDefaultResponse
 * @version 6.35.0
 */
class GetChannelsDefaultResponse {
    /**
     * Constructs a new <code>GetChannelsDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetChannelsDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetChannelsDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetChannelsDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetChannelsDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetChannelsDefaultResponse} The populated <code>GetChannelsDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetChannelsDefaultResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetChannelsDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetChannelsDefaultResponse</code>.
     */
 ...
 */
GetChannelsDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetChannelsDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetChannelsDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetChannelsDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<Object>} Result
 */
GetChannelsDefaultResponse.prototype['Result'] = undefined;
...
export default GetChannelsDefaultResponse;
