...
import LoginUserMapping from './LoginUserMapping';
import OperationResult from './OperationResult';

/**
 * The GetLoginUserMappingDefaultResponse model module.
 * @module com.alterian.ja.model/GetLoginUserMappingDefaultResponse
 * @version 6.35.0
 */
class GetLoginUserMappingDefaultResponse {
    /**
     * Constructs a new <code>GetLoginUserMappingDefaultResponse</code>.
     * @alias module:com.alterian.ja.model/GetLoginUserMappingDefaultResponse
     * @implements module:com.alterian.ja.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetLoginUserMappingDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetLoginUserMappingDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.ja.model/GetLoginUserMappingDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.ja.model/GetLoginUserMappingDefaultResponse} The populated <code>GetLoginUserMappingDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetLoginUserMappingDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = LoginUserMapping.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetLoginUserMappingDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLoginUserMappingDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          LoginUserMapping.validateJSON(data['Result']);
        }
 ...
 */
GetLoginUserMappingDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetLoginUserMappingDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetLoginUserMappingDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.ja.model/APICursor} Cursor
 */
GetLoginUserMappingDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.ja.model/LoginUserMapping} Result
 */
GetLoginUserMappingDefaultResponse.prototype['Result'] = undefined;
...
export default GetLoginUserMappingDefaultResponse;
