...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetClientSetsDefaultResponse();
  });
  ...
  describe('GetClientSetsDefaultResponse', function() {
    it('should create an instance of GetClientSetsDefaultResponse', function() {
      // uncomment below and update the code to test GetClientSetsDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetClientSetsDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetClientSetsDefaultResponse);
    });
