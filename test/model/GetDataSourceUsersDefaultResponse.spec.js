...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetDataSourceUsersDefaultResponse();
  });
  ...
  describe('GetDataSourceUsersDefaultResponse', function() {
    it('should create an instance of GetDataSourceUsersDefaultResponse', function() {
      // uncomment below and update the code to test GetDataSourceUsersDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetDataSourceUsersDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetDataSourceUsersDefaultResponse);
    });
