...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.AUTHGetLoginPasswordRulesDefaultResponse();
  });
  ...
  describe('AUTHGetLoginPasswordRulesDefaultResponse', function() {
    it('should create an instance of AUTHGetLoginPasswordRulesDefaultResponse', function() {
      // uncomment below and update the code to test AUTHGetLoginPasswordRulesDefaultResponse
      //var instance = new JourneyAnalyticsApi.AUTHGetLoginPasswordRulesDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.AUTHGetLoginPasswordRulesDefaultResponse);
    });
