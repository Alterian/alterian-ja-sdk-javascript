...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.EMPrimaryKeysDefaultResponse();
  });
  ...
  describe('EMPrimaryKeysDefaultResponse', function() {
    it('should create an instance of EMPrimaryKeysDefaultResponse', function() {
      // uncomment below and update the code to test EMPrimaryKeysDefaultResponse
      //var instance = new JourneyAnalyticsApi.EMPrimaryKeysDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.EMPrimaryKeysDefaultResponse);
    });
