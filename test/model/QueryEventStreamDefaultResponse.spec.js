...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.QueryEventStreamDefaultResponse();
  });
  ...
  describe('QueryEventStreamDefaultResponse', function() {
    it('should create an instance of QueryEventStreamDefaultResponse', function() {
      // uncomment below and update the code to test QueryEventStreamDefaultResponse
      //var instance = new JourneyAnalyticsApi.QueryEventStreamDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.QueryEventStreamDefaultResponse);
    });
