...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetPatternsDefaultResponse();
  });
  ...
  describe('GetPatternsDefaultResponse', function() {
    it('should create an instance of GetPatternsDefaultResponse', function() {
      // uncomment below and update the code to test GetPatternsDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetPatternsDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetPatternsDefaultResponse);
    });
