...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.EMGetClientGroupsDefaultResponse();
  });
  ...
  describe('EMGetClientGroupsDefaultResponse', function() {
    it('should create an instance of EMGetClientGroupsDefaultResponse', function() {
      // uncomment below and update the code to test EMGetClientGroupsDefaultResponse
      //var instance = new JourneyAnalyticsApi.EMGetClientGroupsDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.EMGetClientGroupsDefaultResponse);
    });
