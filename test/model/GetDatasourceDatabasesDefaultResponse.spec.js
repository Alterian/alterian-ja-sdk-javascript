...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetDatasourceDatabasesDefaultResponse();
  });
  ...
  describe('GetDatasourceDatabasesDefaultResponse', function() {
    it('should create an instance of GetDatasourceDatabasesDefaultResponse', function() {
      // uncomment below and update the code to test GetDatasourceDatabasesDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetDatasourceDatabasesDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetDatasourceDatabasesDefaultResponse);
    });
