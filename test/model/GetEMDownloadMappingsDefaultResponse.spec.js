...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetEMDownloadMappingsDefaultResponse();
  });
  ...
  describe('GetEMDownloadMappingsDefaultResponse', function() {
    it('should create an instance of GetEMDownloadMappingsDefaultResponse', function() {
      // uncomment below and update the code to test GetEMDownloadMappingsDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetEMDownloadMappingsDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetEMDownloadMappingsDefaultResponse);
    });
