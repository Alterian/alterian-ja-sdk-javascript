...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetDataSourceEngineUserNameDefaultResponse();
  });
  ...
  describe('GetDataSourceEngineUserNameDefaultResponse', function() {
    it('should create an instance of GetDataSourceEngineUserNameDefaultResponse', function() {
      // uncomment below and update the code to test GetDataSourceEngineUserNameDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetDataSourceEngineUserNameDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetDataSourceEngineUserNameDefaultResponse);
    });
