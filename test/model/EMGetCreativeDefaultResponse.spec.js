...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.EMGetCreativeDefaultResponse();
  });
  ...
  describe('EMGetCreativeDefaultResponse', function() {
    it('should create an instance of EMGetCreativeDefaultResponse', function() {
      // uncomment below and update the code to test EMGetCreativeDefaultResponse
      //var instance = new JourneyAnalyticsApi.EMGetCreativeDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.EMGetCreativeDefaultResponse);
    });
