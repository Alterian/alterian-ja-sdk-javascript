...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.CreateVisualisationFavouriteRequest();
  });
  ...
  describe('CreateVisualisationFavouriteRequest', function() {
    it('should create an instance of CreateVisualisationFavouriteRequest', function() {
      // uncomment below and update the code to test CreateVisualisationFavouriteRequest
      //var instance = new JourneyAnalyticsApi.CreateVisualisationFavouriteRequest();
      //expect(instance).to.be.a(JourneyAnalyticsApi.CreateVisualisationFavouriteRequest);
    });
