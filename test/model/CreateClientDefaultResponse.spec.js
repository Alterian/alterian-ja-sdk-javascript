...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.CreateClientDefaultResponse();
  });
  ...
  describe('CreateClientDefaultResponse', function() {
    it('should create an instance of CreateClientDefaultResponse', function() {
      // uncomment below and update the code to test CreateClientDefaultResponse
      //var instance = new JourneyAnalyticsApi.CreateClientDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.CreateClientDefaultResponse);
    });
