...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetDatasourceDefaultResponse();
  });
  ...
  describe('GetDatasourceDefaultResponse', function() {
    it('should create an instance of GetDatasourceDefaultResponse', function() {
      // uncomment below and update the code to test GetDatasourceDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetDatasourceDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetDatasourceDefaultResponse);
    });
