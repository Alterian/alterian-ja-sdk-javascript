...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.ApplicationDetails();
  });
  ...
  describe('ApplicationDetails', function() {
    it('should create an instance of ApplicationDetails', function() {
      ...
      //var instance = new JourneyAnalyticsApi.ApplicationDetails();
      //expect(instance).to.be.a(JourneyAnalyticsApi.ApplicationDetails);
    });
