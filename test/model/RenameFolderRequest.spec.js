...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.RenameFolderRequest();
  });
  ...
  describe('RenameFolderRequest', function() {
    it('should create an instance of RenameFolderRequest', function() {
      // uncomment below and update the code to test RenameFolderRequest
      //var instance = new JourneyAnalyticsApi.RenameFolderRequest();
      //expect(instance).to.be.a(JourneyAnalyticsApi.RenameFolderRequest);
    });
