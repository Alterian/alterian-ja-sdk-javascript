...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.ClearPermissionsRequest();
  });
  ...
  describe('ClearPermissionsRequest', function() {
    it('should create an instance of ClearPermissionsRequest', function() {
      // uncomment below and update the code to test ClearPermissionsRequest
      //var instance = new JourneyAnalyticsApi.ClearPermissionsRequest();
      //expect(instance).to.be.a(JourneyAnalyticsApi.ClearPermissionsRequest);
    });
