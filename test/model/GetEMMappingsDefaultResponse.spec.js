...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetEMMappingsDefaultResponse();
  });
  ...
  describe('GetEMMappingsDefaultResponse', function() {
    it('should create an instance of GetEMMappingsDefaultResponse', function() {
      // uncomment below and update the code to test GetEMMappingsDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetEMMappingsDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetEMMappingsDefaultResponse);
    });
