...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.ALDataSourceDatabase();
  });
  ...
  describe('ALDataSourceDatabase', function() {
    it('should create an instance of ALDataSourceDatabase', function() {
      // uncomment below and update the code to test ALDataSourceDatabase
      //var instance = new JourneyAnalyticsApi.ALDataSourceDatabase();
      //expect(instance).to.be.a(JourneyAnalyticsApi.ALDataSourceDatabase);
    });
