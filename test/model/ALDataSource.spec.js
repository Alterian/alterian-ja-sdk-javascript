...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.ALDataSource();
  });
  ...
  describe('ALDataSource', function() {
    it('should create an instance of ALDataSource', function() {
      // uncomment below and update the code to test ALDataSource
      //var instance = new JourneyAnalyticsApi.ALDataSource();
      //expect(instance).to.be.a(JourneyAnalyticsApi.ALDataSource);
    });
