...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetDatasourceColumnsRequest();
  });
  ...
  describe('GetDatasourceColumnsRequest', function() {
    it('should create an instance of GetDatasourceColumnsRequest', function() {
      // uncomment below and update the code to test GetDatasourceColumnsRequest
      //var instance = new JourneyAnalyticsApi.GetDatasourceColumnsRequest();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetDatasourceColumnsRequest);
    });
