...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetBusinessGoalsDefaultResponse();
  });
  ...
  describe('GetBusinessGoalsDefaultResponse', function() {
    it('should create an instance of GetBusinessGoalsDefaultResponse', function() {
      // uncomment below and update the code to test GetBusinessGoalsDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetBusinessGoalsDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetBusinessGoalsDefaultResponse);
    });
