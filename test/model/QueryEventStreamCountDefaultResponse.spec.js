...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.QueryEventStreamCountDefaultResponse();
  });
  ...
  describe('QueryEventStreamCountDefaultResponse', function() {
    it('should create an instance of QueryEventStreamCountDefaultResponse', function() {
      // uncomment below and update the code to test QueryEventStreamCountDefaultResponse
      //var instance = new JourneyAnalyticsApi.QueryEventStreamCountDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.QueryEventStreamCountDefaultResponse);
    });
