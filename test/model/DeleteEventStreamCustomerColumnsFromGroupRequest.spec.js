...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.DeleteEventStreamCustomerColumnsFromGroupRequest();
  });
  ...
  describe('DeleteEventStreamCustomerColumnsFromGroupRequest', function() {
    it('should create an instance of DeleteEventStreamCustomerColumnsFromGroupRequest', function() {
      // uncomment below and update the code to test DeleteEventStreamCustomerColumnsFromGroupRequest
      //var instance = new JourneyAnalyticsApi.DeleteEventStreamCustomerColumnsFromGroupRequest();
      //expect(instance).to.be.a(JourneyAnalyticsApi.DeleteEventStreamCustomerColumnsFromGroupRequest);
    });
