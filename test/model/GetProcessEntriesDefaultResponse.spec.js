...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetProcessEntriesDefaultResponse();
  });
  ...
  describe('GetProcessEntriesDefaultResponse', function() {
    it('should create an instance of GetProcessEntriesDefaultResponse', function() {
      // uncomment below and update the code to test GetProcessEntriesDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetProcessEntriesDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetProcessEntriesDefaultResponse);
    });
