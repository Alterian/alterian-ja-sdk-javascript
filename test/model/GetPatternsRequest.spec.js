...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetPatternsRequest();
  });
  ...
  describe('GetPatternsRequest', function() {
    it('should create an instance of GetPatternsRequest', function() {
      // uncomment below and update the code to test GetPatternsRequest
      //var instance = new JourneyAnalyticsApi.GetPatternsRequest();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetPatternsRequest);
    });
