...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetOpportunitiesDefaultResponse();
  });
  ...
  describe('GetOpportunitiesDefaultResponse', function() {
    it('should create an instance of GetOpportunitiesDefaultResponse', function() {
      // uncomment below and update the code to test GetOpportunitiesDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetOpportunitiesDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetOpportunitiesDefaultResponse);
    });
