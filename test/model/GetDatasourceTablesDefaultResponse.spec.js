...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetDatasourceTablesDefaultResponse();
  });
  ...
  describe('GetDatasourceTablesDefaultResponse', function() {
    it('should create an instance of GetDatasourceTablesDefaultResponse', function() {
      // uncomment below and update the code to test GetDatasourceTablesDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetDatasourceTablesDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetDatasourceTablesDefaultResponse);
    });
