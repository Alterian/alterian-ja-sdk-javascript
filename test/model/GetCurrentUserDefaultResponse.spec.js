...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetCurrentUserDefaultResponse();
  });
  ...
  describe('GetCurrentUserDefaultResponse', function() {
    it('should create an instance of GetCurrentUserDefaultResponse', function() {
      // uncomment below and update the code to test GetCurrentUserDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetCurrentUserDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetCurrentUserDefaultResponse);
    });
