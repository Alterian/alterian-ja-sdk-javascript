...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.QueryEventStreamTransitionRequest();
  });
  ...
  describe('QueryEventStreamTransitionRequest', function() {
    it('should create an instance of QueryEventStreamTransitionRequest', function() {
      // uncomment below and update the code to test QueryEventStreamTransitionRequest
      //var instance = new JourneyAnalyticsApi.QueryEventStreamTransitionRequest();
      //expect(instance).to.be.a(JourneyAnalyticsApi.QueryEventStreamTransitionRequest);
    });
    ...
    it('should have the property fromMatchEvents (base name: "FromMatchEvents")', function() {
      // uncomment below and update the code to test the property fromMatchEvents
      //var instance = new JourneyAnalyticsApi.QueryEventStreamTransitionRequest();
      //expect(instance).to.be();
    });

    it('should have the property includeFromMatchedEvents (base name: "IncludeFromMatchedEvents")', function() {
      // uncomment below and update the code to test the property includeFromMatchedEvents
      //var instance = new JourneyAnalyticsApi.QueryEventStreamTransitionRequest();
      //expect(instance).to.be();
    });

    it('should have the property includeToMatchedEvents (base name: "IncludeToMatchedEvents")', function() {
      // uncomment below and update the code to test the property includeToMatchedEvents
      //var instance = new JourneyAnalyticsApi.QueryEventStreamTransitionRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property toMatchEvents (base name: "ToMatchEvents")', function() {
      // uncomment below and update the code to test the property toMatchEvents
      //var instance = new JourneyAnalyticsApi.QueryEventStreamTransitionRequest();
      //expect(instance).to.be();
    });
