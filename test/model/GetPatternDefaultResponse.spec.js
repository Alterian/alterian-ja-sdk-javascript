...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetPatternDefaultResponse();
  });
  ...
  describe('GetPatternDefaultResponse', function() {
    it('should create an instance of GetPatternDefaultResponse', function() {
      // uncomment below and update the code to test GetPatternDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetPatternDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetPatternDefaultResponse);
    });
