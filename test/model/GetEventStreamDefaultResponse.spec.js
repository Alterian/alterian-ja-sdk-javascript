...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetEventStreamDefaultResponse();
  });
  ...
  describe('GetEventStreamDefaultResponse', function() {
    it('should create an instance of GetEventStreamDefaultResponse', function() {
      // uncomment below and update the code to test GetEventStreamDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetEventStreamDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetEventStreamDefaultResponse);
    });
