...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetEventRecordsDefaultResponse();
  });
  ...
  describe('GetEventRecordsDefaultResponse', function() {
    it('should create an instance of GetEventRecordsDefaultResponse', function() {
      // uncomment below and update the code to test GetEventRecordsDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetEventRecordsDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetEventRecordsDefaultResponse);
    });
