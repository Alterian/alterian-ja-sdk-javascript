...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetLoginUserMappingDefaultResponse();
  });
  ...
  describe('GetLoginUserMappingDefaultResponse', function() {
    it('should create an instance of GetLoginUserMappingDefaultResponse', function() {
      // uncomment below and update the code to test GetLoginUserMappingDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetLoginUserMappingDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetLoginUserMappingDefaultResponse);
    });
