...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetDecodeListDefaultResponse();
  });
  ...
  describe('GetDecodeListDefaultResponse', function() {
    it('should create an instance of GetDecodeListDefaultResponse', function() {
      // uncomment below and update the code to test GetDecodeListDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetDecodeListDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetDecodeListDefaultResponse);
    });
