...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.ListWebSpoonDefaultResponse();
  });
  ...
  describe('ListWebSpoonDefaultResponse', function() {
    it('should create an instance of ListWebSpoonDefaultResponse', function() {
      // uncomment below and update the code to test ListWebSpoonDefaultResponse
      //var instance = new JourneyAnalyticsApi.ListWebSpoonDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.ListWebSpoonDefaultResponse);
    });
