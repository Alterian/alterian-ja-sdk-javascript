...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetTokenDetailsDefaultResponse();
  });
  ...
  describe('GetTokenDetailsDefaultResponse', function() {
    it('should create an instance of GetTokenDetailsDefaultResponse', function() {
      // uncomment below and update the code to test GetTokenDetailsDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetTokenDetailsDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetTokenDetailsDefaultResponse);
    });
