...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetChannelsDefaultResponse();
  });
  ...
  describe('GetChannelsDefaultResponse', function() {
    it('should create an instance of GetChannelsDefaultResponse', function() {
      // uncomment below and update the code to test GetChannelsDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetChannelsDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetChannelsDefaultResponse);
    });
