...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.DeleteEventStreamCustomerColumnsRequest();
  });
  ...
  describe('DeleteEventStreamCustomerColumnsRequest', function() {
    it('should create an instance of DeleteEventStreamCustomerColumnsRequest', function() {
      // uncomment below and update the code to test DeleteEventStreamCustomerColumnsRequest
      //var instance = new JourneyAnalyticsApi.DeleteEventStreamCustomerColumnsRequest();
      //expect(instance).to.be.a(JourneyAnalyticsApi.DeleteEventStreamCustomerColumnsRequest);
    });
