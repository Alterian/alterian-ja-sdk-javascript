...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.BusinessGoalKPI();
  });
  ...
  describe('BusinessGoalKPI', function() {
    it('should create an instance of BusinessGoalKPI', function() {
      // uncomment below and update the code to test BusinessGoalKPI
      //var instance = new JourneyAnalyticsApi.BusinessGoalKPI();
      //expect(instance).to.be.a(JourneyAnalyticsApi.BusinessGoalKPI);
    });
