...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetPermissionsDefaultResponse();
  });
  ...
  describe('GetPermissionsDefaultResponse', function() {
    it('should create an instance of GetPermissionsDefaultResponse', function() {
      // uncomment below and update the code to test GetPermissionsDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetPermissionsDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetPermissionsDefaultResponse);
    });
