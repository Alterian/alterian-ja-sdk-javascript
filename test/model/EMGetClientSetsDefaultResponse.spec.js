...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.EMGetClientSetsDefaultResponse();
  });
  ...
  describe('EMGetClientSetsDefaultResponse', function() {
    it('should create an instance of EMGetClientSetsDefaultResponse', function() {
      // uncomment below and update the code to test EMGetClientSetsDefaultResponse
      //var instance = new JourneyAnalyticsApi.EMGetClientSetsDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.EMGetClientSetsDefaultResponse);
    });
