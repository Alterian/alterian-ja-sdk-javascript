...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.OperationResult();
  });
  ...
  describe('OperationResult', function() {
    it('should create an instance of OperationResult', function() {
      ...
      //var instance = new JourneyAnalyticsApi.OperationResult();
      //expect(instance).to.be.a(JourneyAnalyticsApi.OperationResult);
    });
