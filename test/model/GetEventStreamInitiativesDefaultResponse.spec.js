...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetEventStreamInitiativesDefaultResponse();
  });
  ...
  describe('GetEventStreamInitiativesDefaultResponse', function() {
    it('should create an instance of GetEventStreamInitiativesDefaultResponse', function() {
      // uncomment below and update the code to test GetEventStreamInitiativesDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetEventStreamInitiativesDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetEventStreamInitiativesDefaultResponse);
    });
