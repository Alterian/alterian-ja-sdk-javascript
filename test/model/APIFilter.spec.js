...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.APIFilter();
  });
  ...
  describe('APIFilter', function() {
    it('should create an instance of APIFilter', function() {
      // uncomment below and update the code to test APIFilter
      //var instance = new JourneyAnalyticsApi.APIFilter();
      //expect(instance).to.be.a(JourneyAnalyticsApi.APIFilter);
    });
