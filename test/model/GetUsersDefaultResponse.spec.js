...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetUsersDefaultResponse();
  });
  ...
  describe('GetUsersDefaultResponse', function() {
    it('should create an instance of GetUsersDefaultResponse', function() {
      // uncomment below and update the code to test GetUsersDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetUsersDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetUsersDefaultResponse);
    });
