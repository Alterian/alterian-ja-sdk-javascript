...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetAvailablePermissionsDefaultResponse();
  });
  ...
  describe('GetAvailablePermissionsDefaultResponse', function() {
    it('should create an instance of GetAvailablePermissionsDefaultResponse', function() {
      // uncomment below and update the code to test GetAvailablePermissionsDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetAvailablePermissionsDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetAvailablePermissionsDefaultResponse);
    });
