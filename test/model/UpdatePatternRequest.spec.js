...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.UpdatePatternRequest();
  });
  ...
  describe('UpdatePatternRequest', function() {
    it('should create an instance of UpdatePatternRequest', function() {
      // uncomment below and update the code to test UpdatePatternRequest
      //var instance = new JourneyAnalyticsApi.UpdatePatternRequest();
      //expect(instance).to.be.a(JourneyAnalyticsApi.UpdatePatternRequest);
    });
