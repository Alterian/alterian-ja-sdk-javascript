...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetCurrentClientDefaultResponse();
  });
  ...
  describe('GetCurrentClientDefaultResponse', function() {
    it('should create an instance of GetCurrentClientDefaultResponse', function() {
      // uncomment below and update the code to test GetCurrentClientDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetCurrentClientDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetCurrentClientDefaultResponse);
    });
