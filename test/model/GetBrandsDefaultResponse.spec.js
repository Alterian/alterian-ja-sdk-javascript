...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetBrandsDefaultResponse();
  });
  ...
  describe('GetBrandsDefaultResponse', function() {
    it('should create an instance of GetBrandsDefaultResponse', function() {
      // uncomment below and update the code to test GetBrandsDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetBrandsDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetBrandsDefaultResponse);
    });
