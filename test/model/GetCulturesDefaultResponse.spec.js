...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetCulturesDefaultResponse();
  });
  ...
  describe('GetCulturesDefaultResponse', function() {
    it('should create an instance of GetCulturesDefaultResponse', function() {
      // uncomment below and update the code to test GetCulturesDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetCulturesDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetCulturesDefaultResponse);
    });
