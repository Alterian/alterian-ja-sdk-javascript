...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetDataSourceTypesDefaultResponse();
  });
  ...
  describe('GetDataSourceTypesDefaultResponse', function() {
    it('should create an instance of GetDataSourceTypesDefaultResponse', function() {
      // uncomment below and update the code to test GetDataSourceTypesDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetDataSourceTypesDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetDataSourceTypesDefaultResponse);
    });
