...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetOpportunityMatrixDefaultResponse();
  });
  ...
  describe('GetOpportunityMatrixDefaultResponse', function() {
    it('should create an instance of GetOpportunityMatrixDefaultResponse', function() {
      // uncomment below and update the code to test GetOpportunityMatrixDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetOpportunityMatrixDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetOpportunityMatrixDefaultResponse);
    });
