...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetProcessApplicationsDefaultResponse();
  });
  ...
  describe('GetProcessApplicationsDefaultResponse', function() {
    it('should create an instance of GetProcessApplicationsDefaultResponse', function() {
      // uncomment below and update the code to test GetProcessApplicationsDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetProcessApplicationsDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetProcessApplicationsDefaultResponse);
    });
