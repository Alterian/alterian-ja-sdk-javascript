...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.AUTHChangePasswordDefaultResponse();
  });
  ...
  describe('AUTHChangePasswordDefaultResponse', function() {
    it('should create an instance of AUTHChangePasswordDefaultResponse', function() {
      // uncomment below and update the code to test AUTHChangePasswordDefaultResponse
      //var instance = new JourneyAnalyticsApi.AUTHChangePasswordDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.AUTHChangePasswordDefaultResponse);
    });
