...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.AUTHGetClientLoginsDefaultResponse();
  });
  ...
  describe('AUTHGetClientLoginsDefaultResponse', function() {
    it('should create an instance of AUTHGetClientLoginsDefaultResponse', function() {
      // uncomment below and update the code to test AUTHGetClientLoginsDefaultResponse
      //var instance = new JourneyAnalyticsApi.AUTHGetClientLoginsDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.AUTHGetClientLoginsDefaultResponse);
    });
