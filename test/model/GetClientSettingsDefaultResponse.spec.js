...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetClientSettingsDefaultResponse();
  });
  ...
  describe('GetClientSettingsDefaultResponse', function() {
    it('should create an instance of GetClientSettingsDefaultResponse', function() {
      // uncomment below and update the code to test GetClientSettingsDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetClientSettingsDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetClientSettingsDefaultResponse);
    });
