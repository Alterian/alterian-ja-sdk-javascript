...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.CreateGroupRequest();
  });
  ...
  describe('CreateGroupRequest', function() {
    it('should create an instance of CreateGroupRequest', function() {
      ...
      //var instance = new JourneyAnalyticsApi.CreateGroupRequest();
      //expect(instance).to.be.a(JourneyAnalyticsApi.CreateGroupRequest);
    });
