...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.CreatePatternTasksDefaultResponse();
  });
  ...
  describe('CreatePatternTasksDefaultResponse', function() {
    it('should create an instance of CreatePatternTasksDefaultResponse', function() {
      // uncomment below and update the code to test CreatePatternTasksDefaultResponse
      //var instance = new JourneyAnalyticsApi.CreatePatternTasksDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.CreatePatternTasksDefaultResponse);
    });
