...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetVisualisationFavouritesDefaultResponse();
  });
  ...
  describe('GetVisualisationFavouritesDefaultResponse', function() {
    it('should create an instance of GetVisualisationFavouritesDefaultResponse', function() {
      // uncomment below and update the code to test GetVisualisationFavouritesDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetVisualisationFavouritesDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetVisualisationFavouritesDefaultResponse);
    });
