...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetDatasourceColumnDefaultResponse();
  });
  ...
  describe('GetDatasourceColumnDefaultResponse', function() {
    it('should create an instance of GetDatasourceColumnDefaultResponse', function() {
      // uncomment below and update the code to test GetDatasourceColumnDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetDatasourceColumnDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetDatasourceColumnDefaultResponse);
    });
