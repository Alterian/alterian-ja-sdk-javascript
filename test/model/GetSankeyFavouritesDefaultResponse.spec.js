...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetSankeyFavouritesDefaultResponse();
  });
  ...
  describe('GetSankeyFavouritesDefaultResponse', function() {
    it('should create an instance of GetSankeyFavouritesDefaultResponse', function() {
      // uncomment below and update the code to test GetSankeyFavouritesDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetSankeyFavouritesDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetSankeyFavouritesDefaultResponse);
    });
