...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetPersonaDefaultResponse();
  });
  ...
  describe('GetPersonaDefaultResponse', function() {
    it('should create an instance of GetPersonaDefaultResponse', function() {
      // uncomment below and update the code to test GetPersonaDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetPersonaDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetPersonaDefaultResponse);
    });
