...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetGroupMembersDefaultResponse();
  });
  ...
  describe('GetGroupMembersDefaultResponse', function() {
    it('should create an instance of GetGroupMembersDefaultResponse', function() {
      // uncomment below and update the code to test GetGroupMembersDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetGroupMembersDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetGroupMembersDefaultResponse);
    });
