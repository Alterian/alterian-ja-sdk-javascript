...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.DeletePatternRequest();
  });
  ...
  describe('DeletePatternRequest', function() {
    it('should create an instance of DeletePatternRequest', function() {
      // uncomment below and update the code to test DeletePatternRequest
      //var instance = new JourneyAnalyticsApi.DeletePatternRequest();
      //expect(instance).to.be.a(JourneyAnalyticsApi.DeletePatternRequest);
    });
