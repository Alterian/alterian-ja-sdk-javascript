...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.EMGetClientInfoDefaultResponse();
  });
  ...
  describe('EMGetClientInfoDefaultResponse', function() {
    it('should create an instance of EMGetClientInfoDefaultResponse', function() {
      // uncomment below and update the code to test EMGetClientInfoDefaultResponse
      //var instance = new JourneyAnalyticsApi.EMGetClientInfoDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.EMGetClientInfoDefaultResponse);
    });
