...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetGroupDefaultResponse();
  });
  ...
  describe('GetGroupDefaultResponse', function() {
    it('should create an instance of GetGroupDefaultResponse', function() {
      // uncomment below and update the code to test GetGroupDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetGroupDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetGroupDefaultResponse);
    });
