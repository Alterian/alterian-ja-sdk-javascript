...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetIdealisedJourneysDefaultResponse();
  });
  ...
  describe('GetIdealisedJourneysDefaultResponse', function() {
    it('should create an instance of GetIdealisedJourneysDefaultResponse', function() {
      // uncomment below and update the code to test GetIdealisedJourneysDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetIdealisedJourneysDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetIdealisedJourneysDefaultResponse);
    });
