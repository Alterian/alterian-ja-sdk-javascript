...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetUsersForClientRequest();
  });
  ...
  describe('GetUsersForClientRequest', function() {
    it('should create an instance of GetUsersForClientRequest', function() {
      // uncomment below and update the code to test GetUsersForClientRequest
      //var instance = new JourneyAnalyticsApi.GetUsersForClientRequest();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetUsersForClientRequest);
    });
