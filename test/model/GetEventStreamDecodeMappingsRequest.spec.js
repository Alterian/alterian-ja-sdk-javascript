...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetEventStreamDecodeMappingsRequest();
  });
  ...
  describe('GetEventStreamDecodeMappingsRequest', function() {
    it('should create an instance of GetEventStreamDecodeMappingsRequest', function() {
      // uncomment below and update the code to test GetEventStreamDecodeMappingsRequest
      //var instance = new JourneyAnalyticsApi.GetEventStreamDecodeMappingsRequest();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetEventStreamDecodeMappingsRequest);
    });
    ...
    it('should have the property includeMappingsMissingFromSample (base name: "IncludeMappingsMissingFromSample")', function() {
      // uncomment below and update the code to test the property includeMappingsMissingFromSample
      //var instance = new JourneyAnalyticsApi.GetEventStreamDecodeMappingsRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property sourceLabelSearch (base name: "SourceLabelSearch")', function() {
      // uncomment below and update the code to test the property sourceLabelSearch
      //var instance = new JourneyAnalyticsApi.GetEventStreamDecodeMappingsRequest();
      //expect(instance).to.be();
    });

    it('should have the property targetLabelMatchList (base name: "TargetLabelMatchList")', function() {
      // uncomment below and update the code to test the property targetLabelMatchList
      //var instance = new JourneyAnalyticsApi.GetEventStreamDecodeMappingsRequest();
      //expect(instance).to.be();
    });
