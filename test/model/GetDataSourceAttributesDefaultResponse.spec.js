...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetDataSourceAttributesDefaultResponse();
  });
  ...
  describe('GetDataSourceAttributesDefaultResponse', function() {
    it('should create an instance of GetDataSourceAttributesDefaultResponse', function() {
      // uncomment below and update the code to test GetDataSourceAttributesDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetDataSourceAttributesDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetDataSourceAttributesDefaultResponse);
    });
