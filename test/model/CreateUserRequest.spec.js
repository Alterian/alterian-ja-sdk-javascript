...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.CreateUserRequest();
  });
  ...
  describe('CreateUserRequest', function() {
    it('should create an instance of CreateUserRequest', function() {
      ...
      //var instance = new JourneyAnalyticsApi.CreateUserRequest();
      //expect(instance).to.be.a(JourneyAnalyticsApi.CreateUserRequest);
    });
