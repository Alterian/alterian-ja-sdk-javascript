...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetTokensDefaultResponse();
  });
  ...
  describe('GetTokensDefaultResponse', function() {
    it('should create an instance of GetTokensDefaultResponse', function() {
      // uncomment below and update the code to test GetTokensDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetTokensDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetTokensDefaultResponse);
    });
