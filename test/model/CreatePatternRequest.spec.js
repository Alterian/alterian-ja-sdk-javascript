...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.CreatePatternRequest();
  });
  ...
  describe('CreatePatternRequest', function() {
    it('should create an instance of CreatePatternRequest', function() {
      // uncomment below and update the code to test CreatePatternRequest
      //var instance = new JourneyAnalyticsApi.CreatePatternRequest();
      //expect(instance).to.be.a(JourneyAnalyticsApi.CreatePatternRequest);
    });
