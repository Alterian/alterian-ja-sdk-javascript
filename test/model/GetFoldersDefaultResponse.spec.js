...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetFoldersDefaultResponse();
  });
  ...
  describe('GetFoldersDefaultResponse', function() {
    it('should create an instance of GetFoldersDefaultResponse', function() {
      // uncomment below and update the code to test GetFoldersDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetFoldersDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetFoldersDefaultResponse);
    });
