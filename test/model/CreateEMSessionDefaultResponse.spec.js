...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.CreateEMSessionDefaultResponse();
  });
  ...
  describe('CreateEMSessionDefaultResponse', function() {
    it('should create an instance of CreateEMSessionDefaultResponse', function() {
      // uncomment below and update the code to test CreateEMSessionDefaultResponse
      //var instance = new JourneyAnalyticsApi.CreateEMSessionDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.CreateEMSessionDefaultResponse);
    });
