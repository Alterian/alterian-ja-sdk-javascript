...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetDataSourcesDefaultResponse();
  });
  ...
  describe('GetDataSourcesDefaultResponse', function() {
    it('should create an instance of GetDataSourcesDefaultResponse', function() {
      // uncomment below and update the code to test GetDataSourcesDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetDataSourcesDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetDataSourcesDefaultResponse);
    });
