...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetEventStreamsDefaultResponse();
  });
  ...
  describe('GetEventStreamsDefaultResponse', function() {
    it('should create an instance of GetEventStreamsDefaultResponse', function() {
      // uncomment below and update the code to test GetEventStreamsDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetEventStreamsDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetEventStreamsDefaultResponse);
    });
