...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetDatasourceDatabasesRequest();
  });
  ...
  describe('GetDatasourceDatabasesRequest', function() {
    it('should create an instance of GetDatasourceDatabasesRequest', function() {
      // uncomment below and update the code to test GetDatasourceDatabasesRequest
      //var instance = new JourneyAnalyticsApi.GetDatasourceDatabasesRequest();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetDatasourceDatabasesRequest);
    });
