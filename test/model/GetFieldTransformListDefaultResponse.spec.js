...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetFieldTransformListDefaultResponse();
  });
  ...
  describe('GetFieldTransformListDefaultResponse', function() {
    it('should create an instance of GetFieldTransformListDefaultResponse', function() {
      // uncomment below and update the code to test GetFieldTransformListDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetFieldTransformListDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetFieldTransformListDefaultResponse);
    });
