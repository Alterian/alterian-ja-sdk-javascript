...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetGroupsWithPermissionDefaultResponse();
  });
  ...
  describe('GetGroupsWithPermissionDefaultResponse', function() {
    it('should create an instance of GetGroupsWithPermissionDefaultResponse', function() {
      // uncomment below and update the code to test GetGroupsWithPermissionDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetGroupsWithPermissionDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetGroupsWithPermissionDefaultResponse);
    });
