...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetDatasourceFieldTypesDefaultResponse();
  });
  ...
  describe('GetDatasourceFieldTypesDefaultResponse', function() {
    it('should create an instance of GetDatasourceFieldTypesDefaultResponse', function() {
      // uncomment below and update the code to test GetDatasourceFieldTypesDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetDatasourceFieldTypesDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetDatasourceFieldTypesDefaultResponse);
    });
