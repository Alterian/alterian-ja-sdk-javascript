...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetLoginBrandDefaultDefaultResponse();
  });
  ...
  describe('GetLoginBrandDefaultDefaultResponse', function() {
    it('should create an instance of GetLoginBrandDefaultDefaultResponse', function() {
      // uncomment below and update the code to test GetLoginBrandDefaultDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetLoginBrandDefaultDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetLoginBrandDefaultDefaultResponse);
    });
