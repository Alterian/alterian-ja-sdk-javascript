...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.EMGetCreativeFieldsDefaultResponse();
  });
  ...
  describe('EMGetCreativeFieldsDefaultResponse', function() {
    it('should create an instance of EMGetCreativeFieldsDefaultResponse', function() {
      // uncomment below and update the code to test EMGetCreativeFieldsDefaultResponse
      //var instance = new JourneyAnalyticsApi.EMGetCreativeFieldsDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.EMGetCreativeFieldsDefaultResponse);
    });
