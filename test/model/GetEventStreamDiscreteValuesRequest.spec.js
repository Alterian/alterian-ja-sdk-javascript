...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetEventStreamDiscreteValuesRequest();
  });
  ...
  describe('GetEventStreamDiscreteValuesRequest', function() {
    it('should create an instance of GetEventStreamDiscreteValuesRequest', function() {
      // uncomment below and update the code to test GetEventStreamDiscreteValuesRequest
      //var instance = new JourneyAnalyticsApi.GetEventStreamDiscreteValuesRequest();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetEventStreamDiscreteValuesRequest);
    });
    ...
    it('should have the property primaryDiscretesColumnName (base name: "PrimaryDiscretesColumnName")', function() {
      // uncomment below and update the code to test the property primaryDiscretesColumnName
      //var instance = new JourneyAnalyticsApi.GetEventStreamDiscreteValuesRequest();
      //expect(instance).to.be();
    });

    it('should have the property primaryDiscretesFilter (base name: "PrimaryDiscretesFilter")', function() {
      // uncomment below and update the code to test the property primaryDiscretesFilter
      //var instance = new JourneyAnalyticsApi.GetEventStreamDiscreteValuesRequest();
      //expect(instance).to.be();
    });

    it('should have the property secondaryDiscretesColumnName (base name: "SecondaryDiscretesColumnName")', function() {
      // uncomment below and update the code to test the property secondaryDiscretesColumnName
      //var instance = new JourneyAnalyticsApi.GetEventStreamDiscreteValuesRequest();
      //expect(instance).to.be();
    });

    it('should have the property secondaryDiscretesFilter (base name: "SecondaryDiscretesFilter")', function() {
      // uncomment below and update the code to test the property secondaryDiscretesFilter
      //var instance = new JourneyAnalyticsApi.GetEventStreamDiscreteValuesRequest();
      //expect(instance).to.be();
    });
