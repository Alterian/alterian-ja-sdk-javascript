...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetFolderDefaultResponse();
  });
  ...
  describe('GetFolderDefaultResponse', function() {
    it('should create an instance of GetFolderDefaultResponse', function() {
      // uncomment below and update the code to test GetFolderDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetFolderDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetFolderDefaultResponse);
    });
