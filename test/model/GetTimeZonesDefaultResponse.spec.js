...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetTimeZonesDefaultResponse();
  });
  ...
  describe('GetTimeZonesDefaultResponse', function() {
    it('should create an instance of GetTimeZonesDefaultResponse', function() {
      // uncomment below and update the code to test GetTimeZonesDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetTimeZonesDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetTimeZonesDefaultResponse);
    });
