...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.CreateWebSpoonDefaultResponse();
  });
  ...
  describe('CreateWebSpoonDefaultResponse', function() {
    it('should create an instance of CreateWebSpoonDefaultResponse', function() {
      // uncomment below and update the code to test CreateWebSpoonDefaultResponse
      //var instance = new JourneyAnalyticsApi.CreateWebSpoonDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.CreateWebSpoonDefaultResponse);
    });
