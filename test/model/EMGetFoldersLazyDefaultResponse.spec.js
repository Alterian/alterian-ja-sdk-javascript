...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.EMGetFoldersLazyDefaultResponse();
  });
  ...
  describe('EMGetFoldersLazyDefaultResponse', function() {
    it('should create an instance of EMGetFoldersLazyDefaultResponse', function() {
      // uncomment below and update the code to test EMGetFoldersLazyDefaultResponse
      //var instance = new JourneyAnalyticsApi.EMGetFoldersLazyDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.EMGetFoldersLazyDefaultResponse);
    });
