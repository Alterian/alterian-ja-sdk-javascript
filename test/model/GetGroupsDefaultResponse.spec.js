...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetGroupsDefaultResponse();
  });
  ...
  describe('GetGroupsDefaultResponse', function() {
    it('should create an instance of GetGroupsDefaultResponse', function() {
      // uncomment below and update the code to test GetGroupsDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetGroupsDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetGroupsDefaultResponse);
    });
