...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetEventStreamModelsDefaultResponse();
  });
  ...
  describe('GetEventStreamModelsDefaultResponse', function() {
    it('should create an instance of GetEventStreamModelsDefaultResponse', function() {
      // uncomment below and update the code to test GetEventStreamModelsDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetEventStreamModelsDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetEventStreamModelsDefaultResponse);
    });
