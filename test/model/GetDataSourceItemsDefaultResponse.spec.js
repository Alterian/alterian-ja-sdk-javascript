...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetDataSourceItemsDefaultResponse();
  });
  ...
  describe('GetDataSourceItemsDefaultResponse', function() {
    it('should create an instance of GetDataSourceItemsDefaultResponse', function() {
      // uncomment below and update the code to test GetDataSourceItemsDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetDataSourceItemsDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetDataSourceItemsDefaultResponse);
    });
