...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetEMMappingsRequest();
  });
  ...
  describe('GetEMMappingsRequest', function() {
    it('should create an instance of GetEMMappingsRequest', function() {
      // uncomment below and update the code to test GetEMMappingsRequest
      //var instance = new JourneyAnalyticsApi.GetEMMappingsRequest();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetEMMappingsRequest);
    });
