...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetEMMappingDefaultResponse();
  });
  ...
  describe('GetEMMappingDefaultResponse', function() {
    it('should create an instance of GetEMMappingDefaultResponse', function() {
      // uncomment below and update the code to test GetEMMappingDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetEMMappingDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetEMMappingDefaultResponse);
    });
