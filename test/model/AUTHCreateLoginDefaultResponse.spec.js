...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.AUTHCreateLoginDefaultResponse();
  });
  ...
  describe('AUTHCreateLoginDefaultResponse', function() {
    it('should create an instance of AUTHCreateLoginDefaultResponse', function() {
      // uncomment below and update the code to test AUTHCreateLoginDefaultResponse
      //var instance = new JourneyAnalyticsApi.AUTHCreateLoginDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.AUTHCreateLoginDefaultResponse);
    });
