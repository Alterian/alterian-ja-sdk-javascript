...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetResourcesDefaultResponse();
  });
  ...
  describe('GetResourcesDefaultResponse', function() {
    it('should create an instance of GetResourcesDefaultResponse', function() {
      // uncomment below and update the code to test GetResourcesDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetResourcesDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetResourcesDefaultResponse);
    });
