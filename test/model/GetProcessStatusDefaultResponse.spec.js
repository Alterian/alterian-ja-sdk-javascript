...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetProcessStatusDefaultResponse();
  });
  ...
  describe('GetProcessStatusDefaultResponse', function() {
    it('should create an instance of GetProcessStatusDefaultResponse', function() {
      // uncomment below and update the code to test GetProcessStatusDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetProcessStatusDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetProcessStatusDefaultResponse);
    });
