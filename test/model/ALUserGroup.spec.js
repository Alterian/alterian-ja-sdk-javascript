...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.ALUserGroup();
  });
  ...
  describe('ALUserGroup', function() {
    it('should create an instance of ALUserGroup', function() {
      // uncomment below and update the code to test ALUserGroup
      //var instance = new JourneyAnalyticsApi.ALUserGroup();
      //expect(instance).to.be.a(JourneyAnalyticsApi.ALUserGroup);
    });
