...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.EMGetClientGroupUsersDefaultResponse();
  });
  ...
  describe('EMGetClientGroupUsersDefaultResponse', function() {
    it('should create an instance of EMGetClientGroupUsersDefaultResponse', function() {
      // uncomment below and update the code to test EMGetClientGroupUsersDefaultResponse
      //var instance = new JourneyAnalyticsApi.EMGetClientGroupUsersDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.EMGetClientGroupUsersDefaultResponse);
    });
