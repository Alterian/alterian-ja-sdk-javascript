...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetDataSourceMappingsDefaultResponse();
  });
  ...
  describe('GetDataSourceMappingsDefaultResponse', function() {
    it('should create an instance of GetDataSourceMappingsDefaultResponse', function() {
      // uncomment below and update the code to test GetDataSourceMappingsDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetDataSourceMappingsDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetDataSourceMappingsDefaultResponse);
    });
