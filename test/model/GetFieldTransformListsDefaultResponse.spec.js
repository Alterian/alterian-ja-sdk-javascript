...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetFieldTransformListsDefaultResponse();
  });
  ...
  describe('GetFieldTransformListsDefaultResponse', function() {
    it('should create an instance of GetFieldTransformListsDefaultResponse', function() {
      // uncomment below and update the code to test GetFieldTransformListsDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetFieldTransformListsDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetFieldTransformListsDefaultResponse);
    });
