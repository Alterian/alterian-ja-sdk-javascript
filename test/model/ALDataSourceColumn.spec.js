...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.ALDataSourceColumn();
  });
  ...
  describe('ALDataSourceColumn', function() {
    it('should create an instance of ALDataSourceColumn', function() {
      // uncomment below and update the code to test ALDataSourceColumn
      //var instance = new JourneyAnalyticsApi.ALDataSourceColumn();
      //expect(instance).to.be.a(JourneyAnalyticsApi.ALDataSourceColumn);
    });
    ...
    it('should have the property nameEx (base name: "NameEx")', function() {
      // uncomment below and update the code to test the property nameEx
      //var instance = new JourneyAnalyticsApi.ALDataSourceColumn();
      //expect(instance).to.be();
    });
    ...
    it('should have the property alchemyFieldTypeID (base name: "AlchemyFieldTypeID")', function() {
      // uncomment below and update the code to test the property alchemyFieldTypeID
      //var instance = new JourneyAnalyticsApi.ALDataSourceColumn();
      //expect(instance).to.be();
    });
    ...
    it('should have the property fullNativeName (base name: "FullNativeName")', function() {
      // uncomment below and update the code to test the property fullNativeName
      //var instance = new JourneyAnalyticsApi.ALDataSourceColumn();
      //expect(instance).to.be();
    });
