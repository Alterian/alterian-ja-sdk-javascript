...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.EMGetCreativesDefaultResponse();
  });
  ...
  describe('EMGetCreativesDefaultResponse', function() {
    it('should create an instance of EMGetCreativesDefaultResponse', function() {
      // uncomment below and update the code to test EMGetCreativesDefaultResponse
      //var instance = new JourneyAnalyticsApi.EMGetCreativesDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.EMGetCreativesDefaultResponse);
    });
