...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.EMGetInboundAddressesDefaultResponse();
  });
  ...
  describe('EMGetInboundAddressesDefaultResponse', function() {
    it('should create an instance of EMGetInboundAddressesDefaultResponse', function() {
      // uncomment below and update the code to test EMGetInboundAddressesDefaultResponse
      //var instance = new JourneyAnalyticsApi.EMGetInboundAddressesDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.EMGetInboundAddressesDefaultResponse);
    });
