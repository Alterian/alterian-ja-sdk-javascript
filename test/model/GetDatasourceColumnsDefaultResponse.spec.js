...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetDatasourceColumnsDefaultResponse();
  });
  ...
  describe('GetDatasourceColumnsDefaultResponse', function() {
    it('should create an instance of GetDatasourceColumnsDefaultResponse', function() {
      // uncomment below and update the code to test GetDatasourceColumnsDefaultResponse
      //var instance = new JourneyAnalyticsApi.GetDatasourceColumnsDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetDatasourceColumnsDefaultResponse);
    });
