...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.RunSequencePredictorDefaultResponse();
  });
  ...
  describe('RunSequencePredictorDefaultResponse', function() {
    it('should create an instance of RunSequencePredictorDefaultResponse', function() {
      // uncomment below and update the code to test RunSequencePredictorDefaultResponse
      //var instance = new JourneyAnalyticsApi.RunSequencePredictorDefaultResponse();
      //expect(instance).to.be.a(JourneyAnalyticsApi.RunSequencePredictorDefaultResponse);
    });
