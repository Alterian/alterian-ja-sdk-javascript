...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.DeleteUserRequest();
  });
  ...
  describe('DeleteUserRequest', function() {
    it('should create an instance of DeleteUserRequest', function() {
      ...
      //var instance = new JourneyAnalyticsApi.DeleteUserRequest();
      //expect(instance).to.be.a(JourneyAnalyticsApi.DeleteUserRequest);
    });
