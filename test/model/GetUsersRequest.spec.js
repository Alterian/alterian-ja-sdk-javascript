...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GetUsersRequest();
  });
  ...
  describe('GetUsersRequest', function() {
    it('should create an instance of GetUsersRequest', function() {
      // uncomment below and update the code to test GetUsersRequest
      //var instance = new JourneyAnalyticsApi.GetUsersRequest();
      //expect(instance).to.be.a(JourneyAnalyticsApi.GetUsersRequest);
    });
