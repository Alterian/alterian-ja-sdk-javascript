...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyAnalyticsApi.GroupsApi();
  });
  ...
  describe('GroupsApi', function() {
    describe('copyGroup', function() {
      it('should call copyGroup successfully', function(done) {
        //uncomment below and update the code to test copyGroup
        //instance.copyGroup(function(error) {
